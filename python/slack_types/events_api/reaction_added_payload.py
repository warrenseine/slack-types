...
#
#     result = reaction_added_payload_from_dict(json.loads(json_string))
...
class ReactionAddedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ReactionAddedPayload':
        assert isinstance(obj, dict)
        ...
        return ReactionAddedPayload(token, team_id, enterprise_id, api_app_id, event, type, event_id, event_time, authorizations, is_ext_shared_channel, event_context, context_team_id, context_enterprise_id)
...
def reaction_added_payload_from_dict(s: Any) -> ReactionAddedPayload:
    return ReactionAddedPayload.from_dict(s)


def reaction_added_payload_to_dict(x: ReactionAddedPayload) -> Any:
    return to_class(ReactionAddedPayload, x)
