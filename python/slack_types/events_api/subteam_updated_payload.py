...
#
#     result = subteam_updated_payload_from_dict(json.loads(json_string))
...
class SubteamUpdatedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'SubteamUpdatedPayload':
        assert isinstance(obj, dict)
        ...
        return SubteamUpdatedPayload(token, team_id, enterprise_id, api_app_id, event, type, event_id, event_time, authorizations, is_ext_shared_channel, event_context)
...
def subteam_updated_payload_from_dict(s: Any) -> SubteamUpdatedPayload:
    return SubteamUpdatedPayload.from_dict(s)


def subteam_updated_payload_to_dict(x: SubteamUpdatedPayload) -> Any:
    return to_class(SubteamUpdatedPayload, x)
