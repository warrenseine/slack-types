...
#
#     result = grid_migration_finished_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        enterprise_id = from_union([from_str, from_none], obj.get("enterprise_id"))
        return Event(type, enterprise_id)
...
@dataclass
class GridMigrationFinishedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'GridMigrationFinishedPayload':
        assert isinstance(obj, dict)
        ...
        return GridMigrationFinishedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def grid_migration_finished_payload_from_dict(s: Any) -> GridMigrationFinishedPayload:
    return GridMigrationFinishedPayload.from_dict(s)


def grid_migration_finished_payload_to_dict(x: GridMigrationFinishedPayload) -> Any:
    return to_class(GridMigrationFinishedPayload, x)
