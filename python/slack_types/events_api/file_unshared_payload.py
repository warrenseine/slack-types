...
#
#     result = file_unshared_payload_from_dict(json.loads(json_string))
...
def file_unshared_payload_from_dict(s: Any) -> FileUnsharedPayload:
    return FileUnsharedPayload.from_dict(s)


def file_unshared_payload_to_dict(x: FileUnsharedPayload) -> Any:
    return to_class(FileUnsharedPayload, x)
