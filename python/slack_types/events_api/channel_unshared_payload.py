...
#
#     result = channel_unshared_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    previously_connected_team_id: Optional[str] = None
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        previously_connected_team_id = from_union([from_str, from_none], obj.get("previously_connected_team_id"))
        ...
        return Event(type, previously_connected_team_id, channel, is_ext_shared, event_ts)

    def to_dict(self) -> dict:
        result: dict = {}
        result["type"] = from_union([from_str, from_none], self.type)
        result["previously_connected_team_id"] = from_union([from_str, from_none], self.previously_connected_team_id)
...
class ChannelUnsharedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ChannelUnsharedPayload':
        assert isinstance(obj, dict)
        ...
        return ChannelUnsharedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def channel_unshared_payload_from_dict(s: Any) -> ChannelUnsharedPayload:
    return ChannelUnsharedPayload.from_dict(s)


def channel_unshared_payload_to_dict(x: ChannelUnsharedPayload) -> Any:
    return to_class(ChannelUnsharedPayload, x)
