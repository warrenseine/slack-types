...
#
#     result = message_channel_topic_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, subtype, user, channel, channel_type, text, topic, ts, event_ts)
...
@dataclass
class MessageChannelTopicPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'MessageChannelTopicPayload':
        assert isinstance(obj, dict)
        ...
        return MessageChannelTopicPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def message_channel_topic_payload_from_dict(s: Any) -> MessageChannelTopicPayload:
    return MessageChannelTopicPayload.from_dict(s)


def message_channel_topic_payload_to_dict(x: MessageChannelTopicPayload) -> Any:
    return to_class(MessageChannelTopicPayload, x)
