...
#
#     result = group_close_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, user, channel)
...
class GroupClosePayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'GroupClosePayload':
        assert isinstance(obj, dict)
        ...
        return GroupClosePayload(token, enterprise_id, team_id, context_team_id, context_enterprise_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def group_close_payload_from_dict(s: Any) -> GroupClosePayload:
    return GroupClosePayload.from_dict(s)


def group_close_payload_to_dict(x: GroupClosePayload) -> Any:
    return to_class(GroupClosePayload, x)
