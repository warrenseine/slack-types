...
class FilePublicPayload:
    ...
    def from_dict(obj: Any) -> 'FilePublicPayload':
        ...
        return FilePublicPayload(token, team_id, enterprise_id, api_app_id, event, type, event_id, event_time, authorizations, is_ext_shared_channel, event_context, context_team_id, context_enterprise_id)
