...
#
#     result = message_channel_archive_payload_from_dict(json.loads(json_string))
...
@dataclass
class MessageChannelArchivePayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'MessageChannelArchivePayload':
        assert isinstance(obj, dict)
        ...
        return MessageChannelArchivePayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def message_channel_archive_payload_from_dict(s: Any) -> MessageChannelArchivePayload:
    return MessageChannelArchivePayload.from_dict(s)


def message_channel_archive_payload_to_dict(x: MessageChannelArchivePayload) -> Any:
    return to_class(MessageChannelArchivePayload, x)
