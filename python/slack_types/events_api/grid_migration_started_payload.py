...
#
#     result = grid_migration_started_payload_from_dict(json.loads(json_string))
...
@dataclass
class GridMigrationStartedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'GridMigrationStartedPayload':
        assert isinstance(obj, dict)
        ...
        return GridMigrationStartedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def grid_migration_started_payload_from_dict(s: Any) -> GridMigrationStartedPayload:
    return GridMigrationStartedPayload.from_dict(s)


def grid_migration_started_payload_to_dict(x: GridMigrationStartedPayload) -> Any:
    return to_class(GridMigrationStartedPayload, x)
