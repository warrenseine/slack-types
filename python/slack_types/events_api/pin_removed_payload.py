...
#
#     result = pin_removed_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, user, channel_id, item, item_user, pin_count, pinned_info, has_pins, event_ts)
...
class PinRemovedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'PinRemovedPayload':
        assert isinstance(obj, dict)
        ...
        return PinRemovedPayload(token, team_id, enterprise_id, api_app_id, event, type, event_id, event_time, authorizations, is_ext_shared_channel, event_context)
...
def pin_removed_payload_from_dict(s: Any) -> PinRemovedPayload:
    return PinRemovedPayload.from_dict(s)


def pin_removed_payload_to_dict(x: PinRemovedPayload) -> Any:
    return to_class(PinRemovedPayload, x)
