...
#
#     result = message_file_share_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, subtype, text, blocks, attachments, files, upload, display_as_bot, user, parent_user_id, ts, thread_ts, channel, event_ts, channel_type)
...
class MessageFileSharePayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'MessageFileSharePayload':
        assert isinstance(obj, dict)
        ...
        return MessageFileSharePayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def message_file_share_payload_from_dict(s: Any) -> MessageFileSharePayload:
    return MessageFileSharePayload.from_dict(s)


def message_file_share_payload_to_dict(x: MessageFileSharePayload) -> Any:
    return to_class(MessageFileSharePayload, x)
