...
#
#     result = subteam_self_added_payload_from_dict(json.loads(json_string))
...
class SubteamSelfAddedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'SubteamSelfAddedPayload':
        assert isinstance(obj, dict)
        ...
        return SubteamSelfAddedPayload(token, team_id, enterprise_id, api_app_id, event, type, event_id, event_time, authorizations, is_ext_shared_channel, event_context)
...
def subteam_self_added_payload_from_dict(s: Any) -> SubteamSelfAddedPayload:
    return SubteamSelfAddedPayload.from_dict(s)


def subteam_self_added_payload_to_dict(x: SubteamSelfAddedPayload) -> Any:
    return to_class(SubteamSelfAddedPayload, x)
