...
#
#     result = user_resource_granted_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, user, scopes, trigger_id)
...
@dataclass
class UserResourceGrantedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'UserResourceGrantedPayload':
        assert isinstance(obj, dict)
        ...
        return UserResourceGrantedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def user_resource_granted_payload_from_dict(s: Any) -> UserResourceGrantedPayload:
    return UserResourceGrantedPayload.from_dict(s)


def user_resource_granted_payload_to_dict(x: UserResourceGrantedPayload) -> Any:
    return to_class(UserResourceGrantedPayload, x)
