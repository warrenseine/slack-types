...
#
#     result = member_left_channel_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, user, channel, channel_type, team, event_ts)
...
@dataclass
class MemberLeftChannelPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'MemberLeftChannelPayload':
        assert isinstance(obj, dict)
        ...
        return MemberLeftChannelPayload(token, team_id, enterprise_id, api_app_id, event, type, event_id, event_time, authorizations, is_ext_shared_channel, event_context, context_team_id, context_enterprise_id)
...
def member_left_channel_payload_from_dict(s: Any) -> MemberLeftChannelPayload:
    return MemberLeftChannelPayload.from_dict(s)


def member_left_channel_payload_to_dict(x: MemberLeftChannelPayload) -> Any:
    return to_class(MemberLeftChannelPayload, x)
