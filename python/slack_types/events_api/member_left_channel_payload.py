...
class MemberLeftChannelPayload:
    ...
    def from_dict(obj: Any) -> 'MemberLeftChannelPayload':
        ...
        return MemberLeftChannelPayload(token, team_id, enterprise_id, api_app_id, event, type, event_id, event_time, authorizations, is_ext_shared_channel, event_context)
