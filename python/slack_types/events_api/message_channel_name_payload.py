...
#
#     result = message_channel_name_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, subtype, team, user, name, old_name, channel, channel_type, text, ts, event_ts)
...
@dataclass
class MessageChannelNamePayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'MessageChannelNamePayload':
        assert isinstance(obj, dict)
        ...
        return MessageChannelNamePayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def message_channel_name_payload_from_dict(s: Any) -> MessageChannelNamePayload:
    return MessageChannelNamePayload.from_dict(s)


def message_channel_name_payload_to_dict(x: MessageChannelNamePayload) -> Any:
    return to_class(MessageChannelNamePayload, x)
