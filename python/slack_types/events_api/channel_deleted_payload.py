...
#
#     result = channel_deleted_payload_from_dict(json.loads(json_string))
...
class ChannelDeletedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ChannelDeletedPayload':
        assert isinstance(obj, dict)
        ...
        return ChannelDeletedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def channel_deleted_payload_from_dict(s: Any) -> ChannelDeletedPayload:
    return ChannelDeletedPayload.from_dict(s)


def channel_deleted_payload_to_dict(x: ChannelDeletedPayload) -> Any:
    return to_class(ChannelDeletedPayload, x)
