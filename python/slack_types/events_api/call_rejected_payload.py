...
#
#     result = call_rejected_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, call_id, user_id, channel_id, external_unique_id)
...
class CallRejectedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'CallRejectedPayload':
        assert isinstance(obj, dict)
        ...
        return CallRejectedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def call_rejected_payload_from_dict(s: Any) -> CallRejectedPayload:
    return CallRejectedPayload.from_dict(s)


def call_rejected_payload_to_dict(x: CallRejectedPayload) -> Any:
    return to_class(CallRejectedPayload, x)
