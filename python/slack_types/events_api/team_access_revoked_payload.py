...
#
#     result = team_access_revoked_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, team_ids, event_ts)
...
@dataclass
class TeamAccessRevokedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'TeamAccessRevokedPayload':
        assert isinstance(obj, dict)
        ...
        return TeamAccessRevokedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, event_id, event_time, event_context, is_ext_shared_channel, event)
...
def team_access_revoked_payload_from_dict(s: Any) -> TeamAccessRevokedPayload:
    return TeamAccessRevokedPayload.from_dict(s)


def team_access_revoked_payload_to_dict(x: TeamAccessRevokedPayload) -> Any:
    return to_class(TeamAccessRevokedPayload, x)
