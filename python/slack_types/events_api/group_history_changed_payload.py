...
#
#     result = group_history_changed_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, latest, ts, event_ts)
...
@dataclass
class GroupHistoryChangedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'GroupHistoryChangedPayload':
        assert isinstance(obj, dict)
        ...
        return GroupHistoryChangedPayload(token, enterprise_id, team_id, context_team_id, context_enterprise_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def group_history_changed_payload_from_dict(s: Any) -> GroupHistoryChangedPayload:
    return GroupHistoryChangedPayload.from_dict(s)


def group_history_changed_payload_to_dict(x: GroupHistoryChangedPayload) -> Any:
    return to_class(GroupHistoryChangedPayload, x)
