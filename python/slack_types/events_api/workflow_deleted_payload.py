...
#
#     result = workflow_deleted_payload_from_dict(json.loads(json_string))
...
class WorkflowDeletedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'WorkflowDeletedPayload':
        assert isinstance(obj, dict)
        ...
        return WorkflowDeletedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def workflow_deleted_payload_from_dict(s: Any) -> WorkflowDeletedPayload:
    return WorkflowDeletedPayload.from_dict(s)


def workflow_deleted_payload_to_dict(x: WorkflowDeletedPayload) -> Any:
    return to_class(WorkflowDeletedPayload, x)
