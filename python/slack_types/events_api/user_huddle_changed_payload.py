...
#
#     result = user_huddle_changed_payload_from_dict(json.loads(json_string))
...
@dataclass
class UserHuddleChangedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'UserHuddleChangedPayload':
        assert isinstance(obj, dict)
        ...
        return UserHuddleChangedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def user_huddle_changed_payload_from_dict(s: Any) -> UserHuddleChangedPayload:
    return UserHuddleChangedPayload.from_dict(s)


def user_huddle_changed_payload_to_dict(x: UserHuddleChangedPayload) -> Any:
    return to_class(UserHuddleChangedPayload, x)
