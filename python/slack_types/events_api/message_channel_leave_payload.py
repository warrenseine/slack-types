...
#
#     result = message_channel_leave_payload_from_dict(json.loads(json_string))
...
@dataclass
class MessageChannelLeavePayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'MessageChannelLeavePayload':
        assert isinstance(obj, dict)
        ...
        return MessageChannelLeavePayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def message_channel_leave_payload_from_dict(s: Any) -> MessageChannelLeavePayload:
    return MessageChannelLeavePayload.from_dict(s)


def message_channel_leave_payload_to_dict(x: MessageChannelLeavePayload) -> Any:
    return to_class(MessageChannelLeavePayload, x)
