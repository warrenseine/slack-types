...
#
#     result = app_rate_limited_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, token, team_id, minute_rate_limited, api_app_id)
...
class AppRateLimitedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'AppRateLimitedPayload':
        assert isinstance(obj, dict)
        token = from_union([from_str, from_none], obj.get("token"))
        enterprise_id = from_union([from_str, from_none], obj.get("enterprise_id"))
        team_id = from_union([from_str, from_none], obj.get("team_id"))
        ...
        return AppRateLimitedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def app_rate_limited_payload_from_dict(s: Any) -> AppRateLimitedPayload:
    return AppRateLimitedPayload.from_dict(s)


def app_rate_limited_payload_to_dict(x: AppRateLimitedPayload) -> Any:
    return to_class(AppRateLimitedPayload, x)
