...
#
#     result = star_added_payload_from_dict(json.loads(json_string))
...
class Message:
    ...
    def from_dict(obj: Any) -> 'Message':
        ...
        return Message(bot_id, type, text, user, ts, app_id, team, bot_profile, is_starred, permalink)
...
class StarAddedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'StarAddedPayload':
        assert isinstance(obj, dict)
        ...
        return StarAddedPayload(token, team_id, enterprise_id, api_app_id, event, type, event_id, event_time, authorizations, is_ext_shared_channel, event_context)
...
def star_added_payload_from_dict(s: Any) -> StarAddedPayload:
    return StarAddedPayload.from_dict(s)


def star_added_payload_to_dict(x: StarAddedPayload) -> Any:
    return to_class(StarAddedPayload, x)
