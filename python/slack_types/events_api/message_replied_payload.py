...
#
#     result = message_replied_payload_from_dict(json.loads(json_string))
...
class Message:
    ...
    def from_dict(obj: Any) -> 'Message':
        ...
        return Message(client_msg_id, type, subtype, user, team, edited, text, blocks, attachments, ts, user_team, source_team, is_starred, pinned_to)
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        ts = from_union([from_str, from_none], obj.get("ts"))
        return Event(type, subtype, channel, hidden, message, event_ts, ts)
...
class MessageRepliedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'MessageRepliedPayload':
        assert isinstance(obj, dict)
        ...
        return MessageRepliedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def message_replied_payload_from_dict(s: Any) -> MessageRepliedPayload:
    return MessageRepliedPayload.from_dict(s)


def message_replied_payload_to_dict(x: MessageRepliedPayload) -> Any:
    return to_class(MessageRepliedPayload, x)
