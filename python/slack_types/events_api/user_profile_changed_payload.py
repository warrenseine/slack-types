...
#
#     result = user_profile_changed_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, user, cache_ts, event_ts)
...
@dataclass
class UserProfileChangedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'UserProfileChangedPayload':
        assert isinstance(obj, dict)
        ...
        return UserProfileChangedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def user_profile_changed_payload_from_dict(s: Any) -> UserProfileChangedPayload:
    return UserProfileChangedPayload.from_dict(s)


def user_profile_changed_payload_to_dict(x: UserProfileChangedPayload) -> Any:
    return to_class(UserProfileChangedPayload, x)
