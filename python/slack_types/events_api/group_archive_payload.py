...
#
#     result = group_archive_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, channel, user, is_moved, event_ts)
...
class GroupArchivePayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'GroupArchivePayload':
        assert isinstance(obj, dict)
        ...
        return GroupArchivePayload(token, team_id, enterprise_id, api_app_id, event, type, event_id, event_time, authorizations, is_ext_shared_channel, event_context, context_team_id, context_enterprise_id)
...
def group_archive_payload_from_dict(s: Any) -> GroupArchivePayload:
    return GroupArchivePayload.from_dict(s)


def group_archive_payload_to_dict(x: GroupArchivePayload) -> Any:
    return to_class(GroupArchivePayload, x)
