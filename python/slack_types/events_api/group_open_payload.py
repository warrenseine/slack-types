...
#
#     result = group_open_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, channel, user)
...
class GroupOpenPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'GroupOpenPayload':
        assert isinstance(obj, dict)
        ...
        return GroupOpenPayload(token, enterprise_id, team_id, context_team_id, context_enterprise_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def group_open_payload_from_dict(s: Any) -> GroupOpenPayload:
    return GroupOpenPayload.from_dict(s)


def group_open_payload_to_dict(x: GroupOpenPayload) -> Any:
    return to_class(GroupOpenPayload, x)
