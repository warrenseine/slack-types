...
class GroupOpenPayload:
    ...
    def from_dict(obj: Any) -> 'GroupOpenPayload':
        ...
        return GroupOpenPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
