...
#
#     result = message_channel_unarchive_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, subtype, team, user, channel, channel_type, text, ts, event_ts)
...
@dataclass
class MessageChannelUnarchivePayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'MessageChannelUnarchivePayload':
        assert isinstance(obj, dict)
        ...
        return MessageChannelUnarchivePayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def message_channel_unarchive_payload_from_dict(s: Any) -> MessageChannelUnarchivePayload:
    return MessageChannelUnarchivePayload.from_dict(s)


def message_channel_unarchive_payload_to_dict(x: MessageChannelUnarchivePayload) -> Any:
    return to_class(MessageChannelUnarchivePayload, x)
