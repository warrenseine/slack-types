...
#
#     result = user_resource_removed_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, user, trigger_id)
...
@dataclass
class UserResourceRemovedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'UserResourceRemovedPayload':
        assert isinstance(obj, dict)
        ...
        return UserResourceRemovedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def user_resource_removed_payload_from_dict(s: Any) -> UserResourceRemovedPayload:
    return UserResourceRemovedPayload.from_dict(s)


def user_resource_removed_payload_to_dict(x: UserResourceRemovedPayload) -> Any:
    return to_class(UserResourceRemovedPayload, x)
