...
#
#     result = dnd_updated_user_payload_from_dict(json.loads(json_string))
...
class DNDUpdatedUserPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'DNDUpdatedUserPayload':
        assert isinstance(obj, dict)
        ...
        return DNDUpdatedUserPayload(token, team_id, enterprise_id, api_app_id, event, type, event_id, event_time, authorizations, is_ext_shared_channel, event_context)
...
def dnd_updated_user_payload_from_dict(s: Any) -> DNDUpdatedUserPayload:
    return DNDUpdatedUserPayload.from_dict(s)


def dnd_updated_user_payload_to_dict(x: DNDUpdatedUserPayload) -> Any:
    return to_class(DNDUpdatedUserPayload, x)
