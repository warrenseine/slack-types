...
#
#     result = file_shared_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(file_id, user_id, file, channel_id, type, event_ts)
...
class FileSharedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'FileSharedPayload':
        assert isinstance(obj, dict)
        ...
        return FileSharedPayload(token, team_id, enterprise_id, api_app_id, event, type, event_id, event_time, authorizations, is_ext_shared_channel, event_context, context_team_id, context_enterprise_id)
...
def file_shared_payload_from_dict(s: Any) -> FileSharedPayload:
    return FileSharedPayload.from_dict(s)


def file_shared_payload_to_dict(x: FileSharedPayload) -> Any:
    return to_class(FileSharedPayload, x)
