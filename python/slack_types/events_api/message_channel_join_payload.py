...
#
#     result = message_channel_join_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, subtype, team, user, inviter, channel, channel_type, text, ts, event_ts)
...
@dataclass
class MessageChannelJoinPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'MessageChannelJoinPayload':
        assert isinstance(obj, dict)
        ...
        return MessageChannelJoinPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def message_channel_join_payload_from_dict(s: Any) -> MessageChannelJoinPayload:
    return MessageChannelJoinPayload.from_dict(s)


def message_channel_join_payload_to_dict(x: MessageChannelJoinPayload) -> Any:
    return to_class(MessageChannelJoinPayload, x)
