...
#
#     result = app_uninstalled_payload_from_dict(json.loads(json_string))
...
class AppUninstalledPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'AppUninstalledPayload':
        assert isinstance(obj, dict)
        ...
        return AppUninstalledPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def app_uninstalled_payload_from_dict(s: Any) -> AppUninstalledPayload:
    return AppUninstalledPayload.from_dict(s)


def app_uninstalled_payload_to_dict(x: AppUninstalledPayload) -> Any:
    return to_class(AppUninstalledPayload, x)
