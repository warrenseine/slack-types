...
#
#     result = message_group_topic_payload_from_dict(json.loads(json_string))
...
@dataclass
class MessageGroupTopicPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'MessageGroupTopicPayload':
        assert isinstance(obj, dict)
        ...
        return MessageGroupTopicPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def message_group_topic_payload_from_dict(s: Any) -> MessageGroupTopicPayload:
    return MessageGroupTopicPayload.from_dict(s)


def message_group_topic_payload_to_dict(x: MessageGroupTopicPayload) -> Any:
    return to_class(MessageGroupTopicPayload, x)
