...
#
#     result = resources_removed_payload_from_dict(json.loads(json_string))
...
class ResourcesRemovedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ResourcesRemovedPayload':
        assert isinstance(obj, dict)
        ...
        return ResourcesRemovedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def resources_removed_payload_from_dict(s: Any) -> ResourcesRemovedPayload:
    return ResourcesRemovedPayload.from_dict(s)


def resources_removed_payload_to_dict(x: ResourcesRemovedPayload) -> Any:
    return to_class(ResourcesRemovedPayload, x)
