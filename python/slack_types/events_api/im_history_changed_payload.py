...
#
#     result = im_history_changed_payload_from_dict(json.loads(json_string))
...
class IMHistoryChangedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'IMHistoryChangedPayload':
        assert isinstance(obj, dict)
        ...
        return IMHistoryChangedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def im_history_changed_payload_from_dict(s: Any) -> IMHistoryChangedPayload:
    return IMHistoryChangedPayload.from_dict(s)


def im_history_changed_payload_to_dict(x: IMHistoryChangedPayload) -> Any:
    return to_class(IMHistoryChangedPayload, x)
