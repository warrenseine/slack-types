...
#
#     result = workflow_unpublished_payload_from_dict(json.loads(json_string))
...
@dataclass
class WorkflowDraftConfiguration:
    version_id: Optional[str] = None

    @staticmethod
    def from_dict(obj: Any) -> 'WorkflowDraftConfiguration':
        assert isinstance(obj, dict)
        version_id = from_union([from_str, from_none], obj.get("version_id"))
        return WorkflowDraftConfiguration(version_id)
...
class Event:
    ...
    workflow_draft_configuration: Optional[WorkflowDraftConfiguration] = None
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        workflow_draft_configuration = from_union([WorkflowDraftConfiguration.from_dict, from_none], obj.get("workflow_draft_configuration"))
        event_ts = from_union([from_str, from_none], obj.get("event_ts"))
        return Event(type, workflow_id, workflow_draft_configuration, event_ts)

    def to_dict(self) -> dict:
        result: dict = {}
        result["type"] = from_union([from_str, from_none], self.type)
        result["workflow_id"] = from_union([from_str, from_none], self.workflow_id)
        result["workflow_draft_configuration"] = from_union([lambda x: to_class(WorkflowDraftConfiguration, x), from_none], self.workflow_draft_configuration)
        result["event_ts"] = from_union([from_str, from_none], self.event_ts)
        return result


@dataclass
class WorkflowUnpublishedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'WorkflowUnpublishedPayload':
        assert isinstance(obj, dict)
        ...
        return WorkflowUnpublishedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def workflow_unpublished_payload_from_dict(s: Any) -> WorkflowUnpublishedPayload:
    return WorkflowUnpublishedPayload.from_dict(s)


def workflow_unpublished_payload_to_dict(x: WorkflowUnpublishedPayload) -> Any:
    return to_class(WorkflowUnpublishedPayload, x)
