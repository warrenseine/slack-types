...
#
#     result = group_rename_payload_from_dict(json.loads(json_string))
...
class Channel:
    ...
    def from_dict(obj: Any) -> 'Channel':
        ...
        return Channel(id, is_channel, is_mpim, name, name_normalized, created)
...
class GroupRenamePayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'GroupRenamePayload':
        assert isinstance(obj, dict)
        ...
        return GroupRenamePayload(token, team_id, enterprise_id, api_app_id, event, type, event_id, event_time, authorizations, is_ext_shared_channel, event_context, context_team_id, context_enterprise_id)
...
def group_rename_payload_from_dict(s: Any) -> GroupRenamePayload:
    return GroupRenamePayload.from_dict(s)


def group_rename_payload_to_dict(x: GroupRenamePayload) -> Any:
    return to_class(GroupRenamePayload, x)
