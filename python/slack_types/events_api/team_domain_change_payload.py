...
#
#     result = team_domain_change_payload_from_dict(json.loads(json_string))
...
class TeamDomainChangePayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'TeamDomainChangePayload':
        assert isinstance(obj, dict)
        ...
        return TeamDomainChangePayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def team_domain_change_payload_from_dict(s: Any) -> TeamDomainChangePayload:
    return TeamDomainChangePayload.from_dict(s)


def team_domain_change_payload_to_dict(x: TeamDomainChangePayload) -> Any:
    return to_class(TeamDomainChangePayload, x)
