...
#
#     result = scope_granted_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, scopes, trigger_id)
...
class ScopeGrantedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ScopeGrantedPayload':
        assert isinstance(obj, dict)
        ...
        return ScopeGrantedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def scope_granted_payload_from_dict(s: Any) -> ScopeGrantedPayload:
    return ScopeGrantedPayload.from_dict(s)


def scope_granted_payload_to_dict(x: ScopeGrantedPayload) -> Any:
    return to_class(ScopeGrantedPayload, x)
