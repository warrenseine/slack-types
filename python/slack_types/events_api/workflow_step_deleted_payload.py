...
#
#     result = workflow_step_deleted_payload_from_dict(json.loads(json_string))
...
class WorkflowConfiguration:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'WorkflowConfiguration':
        assert isinstance(obj, dict)
        version_id = from_union([from_str, from_none], obj.get("version_id"))
        return WorkflowConfiguration(version_id)

    def to_dict(self) -> dict:
        result: dict = {}
        result["version_id"] = from_union([from_str, from_none], self.version_id)
        return result
...
class Event:
    ...
    workflow_draft_configuration: Optional[WorkflowConfiguration] = None
    workflow_published_configuration: Optional[WorkflowConfiguration] = None
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        workflow_draft_configuration = from_union([WorkflowConfiguration.from_dict, from_none], obj.get("workflow_draft_configuration"))
        workflow_published_configuration = from_union([WorkflowConfiguration.from_dict, from_none], obj.get("workflow_published_configuration"))
        event_ts = from_union([from_str, from_none], obj.get("event_ts"))
        return Event(type, workflow_id, workflow_draft_configuration, workflow_published_configuration, event_ts)

    def to_dict(self) -> dict:
        result: dict = {}
        result["type"] = from_union([from_str, from_none], self.type)
        result["workflow_id"] = from_union([from_str, from_none], self.workflow_id)
        result["workflow_draft_configuration"] = from_union([lambda x: to_class(WorkflowConfiguration, x), from_none], self.workflow_draft_configuration)
        result["workflow_published_configuration"] = from_union([lambda x: to_class(WorkflowConfiguration, x), from_none], self.workflow_published_configuration)
...
class WorkflowStepDeletedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'WorkflowStepDeletedPayload':
        assert isinstance(obj, dict)
        ...
        return WorkflowStepDeletedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def workflow_step_deleted_payload_from_dict(s: Any) -> WorkflowStepDeletedPayload:
    return WorkflowStepDeletedPayload.from_dict(s)


def workflow_step_deleted_payload_to_dict(x: WorkflowStepDeletedPayload) -> Any:
    return to_class(WorkflowStepDeletedPayload, x)
