...
#
#     result = resources_added_payload_from_dict(json.loads(json_string))
...
class ResourcesAddedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ResourcesAddedPayload':
        assert isinstance(obj, dict)
        ...
        return ResourcesAddedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def resources_added_payload_from_dict(s: Any) -> ResourcesAddedPayload:
    return ResourcesAddedPayload.from_dict(s)


def resources_added_payload_to_dict(x: ResourcesAddedPayload) -> Any:
    return to_class(ResourcesAddedPayload, x)
