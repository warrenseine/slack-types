...
#
#     result = message_ekm_access_denied_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, subtype, channel, hidden, user, text, blocks, attachments, event_ts, ts, channel_type)
...
@dataclass
class MessageEkmAccessDeniedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'MessageEkmAccessDeniedPayload':
        assert isinstance(obj, dict)
        ...
        return MessageEkmAccessDeniedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def message_ekm_access_denied_payload_from_dict(s: Any) -> MessageEkmAccessDeniedPayload:
    return MessageEkmAccessDeniedPayload.from_dict(s)


def message_ekm_access_denied_payload_to_dict(x: MessageEkmAccessDeniedPayload) -> Any:
    return to_class(MessageEkmAccessDeniedPayload, x)
