...
#
#     result = im_close_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, user, channel, event_ts)
...
class IMClosePayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'IMClosePayload':
        assert isinstance(obj, dict)
        ...
        return IMClosePayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def im_close_payload_from_dict(s: Any) -> IMClosePayload:
    return IMClosePayload.from_dict(s)


def im_close_payload_to_dict(x: IMClosePayload) -> Any:
    return to_class(IMClosePayload, x)
