...
#
#     result = email_domain_changed_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, email_domain, event_ts)
...
@dataclass
class EmailDomainChangedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'EmailDomainChangedPayload':
        assert isinstance(obj, dict)
        ...
        return EmailDomainChangedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def email_domain_changed_payload_from_dict(s: Any) -> EmailDomainChangedPayload:
    return EmailDomainChangedPayload.from_dict(s)


def email_domain_changed_payload_to_dict(x: EmailDomainChangedPayload) -> Any:
    return to_class(EmailDomainChangedPayload, x)
