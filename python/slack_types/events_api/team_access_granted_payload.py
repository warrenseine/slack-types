...
#
#     result = team_access_granted_payload_from_dict(json.loads(json_string))
...
@dataclass
class TeamAccessGrantedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'TeamAccessGrantedPayload':
        assert isinstance(obj, dict)
        ...
        return TeamAccessGrantedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, event_id, event_time, event_context, is_ext_shared_channel, event)
...
def team_access_granted_payload_from_dict(s: Any) -> TeamAccessGrantedPayload:
    return TeamAccessGrantedPayload.from_dict(s)


def team_access_granted_payload_to_dict(x: TeamAccessGrantedPayload) -> Any:
    return to_class(TeamAccessGrantedPayload, x)
