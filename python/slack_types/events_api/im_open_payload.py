...
#
#     result = im_open_payload_from_dict(json.loads(json_string))
...
class IMOpenPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'IMOpenPayload':
        assert isinstance(obj, dict)
        ...
        return IMOpenPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def im_open_payload_from_dict(s: Any) -> IMOpenPayload:
    return IMOpenPayload.from_dict(s)


def im_open_payload_to_dict(x: IMOpenPayload) -> Any:
    return to_class(IMOpenPayload, x)
