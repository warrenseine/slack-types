...
#
#     result = channel_shared_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        connected_team_id = from_union([from_str, from_none], obj.get("connected_team_id"))
        channel = from_union([from_str, from_none], obj.get("channel"))
        event_ts = from_union([from_str, from_none], obj.get("event_ts"))
        return Event(type, connected_team_id, channel, event_ts)

    def to_dict(self) -> dict:
        result: dict = {}
        result["type"] = from_union([from_str, from_none], self.type)
        result["connected_team_id"] = from_union([from_str, from_none], self.connected_team_id)
...
class ChannelSharedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ChannelSharedPayload':
        assert isinstance(obj, dict)
        ...
        return ChannelSharedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def channel_shared_payload_from_dict(s: Any) -> ChannelSharedPayload:
    return ChannelSharedPayload.from_dict(s)


def channel_shared_payload_to_dict(x: ChannelSharedPayload) -> Any:
    return to_class(ChannelSharedPayload, x)
