...
#
#     result = group_unarchive_payload_from_dict(json.loads(json_string))
...
class GroupUnarchivePayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'GroupUnarchivePayload':
        assert isinstance(obj, dict)
        ...
        return GroupUnarchivePayload(token, team_id, enterprise_id, api_app_id, event, type, event_id, event_time, authorizations, is_ext_shared_channel, event_context)
...
def group_unarchive_payload_from_dict(s: Any) -> GroupUnarchivePayload:
    return GroupUnarchivePayload.from_dict(s)


def group_unarchive_payload_to_dict(x: GroupUnarchivePayload) -> Any:
    return to_class(GroupUnarchivePayload, x)
