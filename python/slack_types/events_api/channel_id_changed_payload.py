...
#
#     result = channel_id_changed_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    old_channel_id: Optional[str] = None
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        old_channel_id = from_union([from_str, from_none], obj.get("old_channel_id"))
        new_channel_id = from_union([from_str, from_none], obj.get("new_channel_id"))
        event_ts = from_union([from_str, from_none], obj.get("event_ts"))
        return Event(type, old_channel_id, new_channel_id, event_ts)

    def to_dict(self) -> dict:
        result: dict = {}
        result["type"] = from_union([from_str, from_none], self.type)
        result["old_channel_id"] = from_union([from_str, from_none], self.old_channel_id)
        result["new_channel_id"] = from_union([from_str, from_none], self.new_channel_id)
        result["event_ts"] = from_union([from_str, from_none], self.event_ts)
        return result


@dataclass
class ChannelIDChangedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ChannelIDChangedPayload':
        assert isinstance(obj, dict)
        ...
        return ChannelIDChangedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def channel_id_changed_payload_from_dict(s: Any) -> ChannelIDChangedPayload:
    return ChannelIDChangedPayload.from_dict(s)


def channel_id_changed_payload_to_dict(x: ChannelIDChangedPayload) -> Any:
    return to_class(ChannelIDChangedPayload, x)
