...
#
#     result = subteam_self_removed_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, subteam_id, event_ts)
...
@dataclass
class SubteamSelfRemovedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'SubteamSelfRemovedPayload':
        assert isinstance(obj, dict)
        ...
        return SubteamSelfRemovedPayload(token, team_id, enterprise_id, api_app_id, event, type, event_id, event_time, authorizations, is_ext_shared_channel, event_context)
...
def subteam_self_removed_payload_from_dict(s: Any) -> SubteamSelfRemovedPayload:
    return SubteamSelfRemovedPayload.from_dict(s)


def subteam_self_removed_payload_to_dict(x: SubteamSelfRemovedPayload) -> Any:
    return to_class(SubteamSelfRemovedPayload, x)
