...
#
#     result = message_channel_purpose_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, subtype, user, channel, channel_type, text, purpose, ts, event_ts)
...
@dataclass
class MessageChannelPurposePayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'MessageChannelPurposePayload':
        assert isinstance(obj, dict)
        ...
        return MessageChannelPurposePayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def message_channel_purpose_payload_from_dict(s: Any) -> MessageChannelPurposePayload:
    return MessageChannelPurposePayload.from_dict(s)


def message_channel_purpose_payload_to_dict(x: MessageChannelPurposePayload) -> Any:
    return to_class(MessageChannelPurposePayload, x)
