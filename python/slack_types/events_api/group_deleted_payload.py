...
#
#     result = group_deleted_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, channel, date_deleted, actor_id, event_ts)
...
class GroupDeletedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'GroupDeletedPayload':
        assert isinstance(obj, dict)
...
def group_deleted_payload_from_dict(s: Any) -> GroupDeletedPayload:
    return GroupDeletedPayload.from_dict(s)


def group_deleted_payload_to_dict(x: GroupDeletedPayload) -> Any:
    return to_class(GroupDeletedPayload, x)
