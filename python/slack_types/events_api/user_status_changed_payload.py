...
#
#     result = user_status_changed_payload_from_dict(json.loads(json_string))
...
@dataclass
class UserStatusChangedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'UserStatusChangedPayload':
        assert isinstance(obj, dict)
        ...
        return UserStatusChangedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def user_status_changed_payload_from_dict(s: Any) -> UserStatusChangedPayload:
    return UserStatusChangedPayload.from_dict(s)


def user_status_changed_payload_to_dict(x: UserStatusChangedPayload) -> Any:
    return to_class(UserStatusChangedPayload, x)
