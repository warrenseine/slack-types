...
#
#     result = user_resource_denied_payload_from_dict(json.loads(json_string))
...
@dataclass
class UserResourceDeniedPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'UserResourceDeniedPayload':
        assert isinstance(obj, dict)
        ...
        return UserResourceDeniedPayload(token, enterprise_id, team_id, api_app_id, type, authed_users, authed_teams, authorizations, is_ext_shared_channel, event_id, event_time, event_context, event)
...
def user_resource_denied_payload_from_dict(s: Any) -> UserResourceDeniedPayload:
    return UserResourceDeniedPayload.from_dict(s)


def user_resource_denied_payload_to_dict(x: UserResourceDeniedPayload) -> Any:
    return to_class(UserResourceDeniedPayload, x)
