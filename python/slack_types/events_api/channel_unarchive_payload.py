...
#
#     result = channel_unarchive_payload_from_dict(json.loads(json_string))
...
class Event:
    ...
    def from_dict(obj: Any) -> 'Event':
        ...
        return Event(type, channel, user, event_ts)
...
class ChannelUnarchivePayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ChannelUnarchivePayload':
        assert isinstance(obj, dict)
        ...
        return ChannelUnarchivePayload(token, team_id, enterprise_id, api_app_id, event, type, event_id, event_time, authorizations, is_ext_shared_channel, event_context)
...
def channel_unarchive_payload_from_dict(s: Any) -> ChannelUnarchivePayload:
    return ChannelUnarchivePayload.from_dict(s)


def channel_unarchive_payload_to_dict(x: ChannelUnarchivePayload) -> Any:
    return to_class(ChannelUnarchivePayload, x)
