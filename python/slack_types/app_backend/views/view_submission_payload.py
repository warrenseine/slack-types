...
#
#     result = view_submission_payload_from_dict(json.loads(json_string))
...
def view_submission_payload_from_dict(s: Any) -> ViewSubmissionPayload:
    return ViewSubmissionPayload.from_dict(s)


def view_submission_payload_to_dict(x: ViewSubmissionPayload) -> Any:
    return to_class(ViewSubmissionPayload, x)
