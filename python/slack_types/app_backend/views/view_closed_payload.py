...
class ViewClosedPayload:
    ...
    def from_dict(obj: Any) -> 'ViewClosedPayload':
        ...
        return ViewClosedPayload(type, enterprise, team, user, api_app_id, token, view, is_enterprise_install, is_cleared, bot_access_token, function_data, interactivity)
