...
#
#     result = message_shortcut_payload_from_dict(json.loads(json_string))
...
class MessageShortcutPayload:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'MessageShortcutPayload':
        assert isinstance(obj, dict)
        type = from_union([from_str, from_none], obj.get("type"))
        callback_id = from_union([from_str, from_none], obj.get("callback_id"))
        ...
        return MessageShortcutPayload(type, callback_id, trigger_id, message_ts, response_url, message, enterprise, team, user, channel, token, action_ts, is_enterprise_install)
...
def message_shortcut_payload_from_dict(s: Any) -> MessageShortcutPayload:
    return MessageShortcutPayload.from_dict(s)


def message_shortcut_payload_to_dict(x: MessageShortcutPayload) -> Any:
    return to_class(MessageShortcutPayload, x)
