...
class Email:
    ...
    def from_dict(obj: Any) -> 'Email':
        ...
        primary = from_union([from_bool, from_none], obj.get("primary"))
        return Email(value, type, primary)
...
class UrnIETFParamsScimSchemasExtensionSlackGuest20User:
    ...
    def from_dict(obj: Any) -> 'UrnIETFParamsScimSchemasExtensionSlackGuest20User':
        ...
        return UrnIETFParamsScimSchemasExtensionSlackGuest20User(type, expiration)
...
class UserResponse:
    ...
    def from_dict(obj: Any) -> 'UserResponse':
        ...
        return UserResponse(errors, schemas, id, external_id, meta, user_name, nick_name, name, display_name, profile_url, title, timezone, active, emails, photos, addresses, phone_numbers, roles, urn_ietf_params_scim_schemas_extension_enterprise_20_user, groups, urn_ietf_params_scim_schemas_extension_slack_guest_20_user)
