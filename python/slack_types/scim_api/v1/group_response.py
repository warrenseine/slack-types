...
#
#     result = group_response_from_dict(json.loads(json_string))
...
class GroupResponse:
    ...
    def from_dict(obj: Any) -> 'GroupResponse':
        ...
        return GroupResponse(schemas, id, display_name, members, meta)
...
def group_response_from_dict(s: Any) -> GroupResponse:
    return GroupResponse.from_dict(s)


def group_response_to_dict(x: GroupResponse) -> Any:
    return to_class(GroupResponse, x)
