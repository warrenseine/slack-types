...
class UserResponse:
    ...
    def from_dict(obj: Any) -> 'UserResponse':
        ...
        return UserResponse(errors, schemas, id, external_id, meta, user_name, nick_name, name, display_name, profile_url, title, timezone, active, emails, photos, groups, addresses, phone_numbers, roles, urn_scim_schemas_extension_enterprise_10, urn_scim_schemas_extension_slack_guest_10)
