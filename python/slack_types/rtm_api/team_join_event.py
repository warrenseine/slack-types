...
#
#     result = team_join_event_from_dict(json.loads(json_string))
...
class TeamJoinEvent:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'TeamJoinEvent':
        assert isinstance(obj, dict)
        type = from_union([from_str, from_none], obj.get("type"))
        user = from_union([User.from_dict, from_none], obj.get("user"))
        return TeamJoinEvent(type, user)
...
def team_join_event_from_dict(s: Any) -> TeamJoinEvent:
    return TeamJoinEvent.from_dict(s)


def team_join_event_to_dict(x: TeamJoinEvent) -> Any:
    return to_class(TeamJoinEvent, x)
