...
#
#     result = channel_rename_event_from_dict(json.loads(json_string))
...
class Channel:
    ...
    def from_dict(obj: Any) -> 'Channel':
        ...
        return Channel(id, name, name_normalized, is_channel, is_mpim, created)
...
class ChannelRenameEvent:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ChannelRenameEvent':
        assert isinstance(obj, dict)
        ...
        return ChannelRenameEvent(type, channel, event_ts)
...
def channel_rename_event_from_dict(s: Any) -> ChannelRenameEvent:
    return ChannelRenameEvent.from_dict(s)


def channel_rename_event_to_dict(x: ChannelRenameEvent) -> Any:
    return to_class(ChannelRenameEvent, x)
