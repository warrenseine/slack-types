...
#
#     result = subteam_created_event_from_dict(json.loads(json_string))
...
class Subteam:
    ...
    def from_dict(obj: Any) -> 'Subteam':
        ...
        return Subteam(id, enterprise_subteam_id, team_id, is_subteam, is_usergroup, auto_provision, name, description, handle, is_external, date_create, date_update, date_delete, auto_type, created_by, updated_by, deleted_by, prefs, user_count, channel_count, users)
...
class SubteamCreatedEvent:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'SubteamCreatedEvent':
        assert isinstance(obj, dict)
        ...
        return SubteamCreatedEvent(type, subteam, event_ts)
...
def subteam_created_event_from_dict(s: Any) -> SubteamCreatedEvent:
    return SubteamCreatedEvent.from_dict(s)


def subteam_created_event_to_dict(x: SubteamCreatedEvent) -> Any:
    return to_class(SubteamCreatedEvent, x)
