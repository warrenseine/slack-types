...
#
#     result = team_profile_delete_event_from_dict(json.loads(json_string))
...
class TeamProfileDeleteEvent:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'TeamProfileDeleteEvent':
        assert isinstance(obj, dict)
        type = from_union([from_str, from_none], obj.get("type"))
        profile = from_union([Profile.from_dict, from_none], obj.get("profile"))
        return TeamProfileDeleteEvent(type, profile)
...
def team_profile_delete_event_from_dict(s: Any) -> TeamProfileDeleteEvent:
    return TeamProfileDeleteEvent.from_dict(s)


def team_profile_delete_event_to_dict(x: TeamProfileDeleteEvent) -> Any:
    return to_class(TeamProfileDeleteEvent, x)
