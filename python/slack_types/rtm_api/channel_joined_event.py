...
#
#     result = channel_joined_event_from_dict(json.loads(json_string))
...
class Channel:
    ...
    def from_dict(obj: Any) -> 'Channel':
        ...
        return Channel(id, name, created, creator)
...
class ChannelJoinedEvent:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ChannelJoinedEvent':
        assert isinstance(obj, dict)
        type = from_union([from_str, from_none], obj.get("type"))
        channel = from_union([Channel.from_dict, from_none], obj.get("channel"))
        return ChannelJoinedEvent(type, channel)
...
def channel_joined_event_from_dict(s: Any) -> ChannelJoinedEvent:
    return ChannelJoinedEvent.from_dict(s)


def channel_joined_event_to_dict(x: ChannelJoinedEvent) -> Any:
    return to_class(ChannelJoinedEvent, x)
