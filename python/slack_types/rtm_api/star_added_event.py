...
#
#     result = star_added_event_from_dict(json.loads(json_string))
...
class ItemMessage:
    ...
    def from_dict(obj: Any) -> 'ItemMessage':
        ...
        permalink = from_union([from_str, from_none], obj.get("permalink"))
        edited = from_union([Edited.from_dict, from_none], obj.get("edited"))
        return ItemMessage(client_msg_id, type, app_id, team, user, bot_id, bot_profile, is_starred, text, blocks, attachments, ts, pinned_to, permalink, edited)
...
def star_added_event_from_dict(s: Any) -> StarAddedEvent:
    return StarAddedEvent.from_dict(s)


def star_added_event_to_dict(x: StarAddedEvent) -> Any:
    return to_class(StarAddedEvent, x)
