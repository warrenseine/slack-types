...
#
#     result = group_unarchive_event_from_dict(json.loads(json_string))
...
class GroupUnarchiveEvent:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'GroupUnarchiveEvent':
        ...
        return GroupUnarchiveEvent(type, channel, actor_id, event_ts)
...
def group_unarchive_event_from_dict(s: Any) -> GroupUnarchiveEvent:
    return GroupUnarchiveEvent.from_dict(s)


def group_unarchive_event_to_dict(x: GroupUnarchiveEvent) -> Any:
    return to_class(GroupUnarchiveEvent, x)
