...
#
#     result = resources_added_event_from_dict(json.loads(json_string))
...
def resources_added_event_from_dict(s: Any) -> ResourcesAddedEvent:
    return ResourcesAddedEvent.from_dict(s)


def resources_added_event_to_dict(x: ResourcesAddedEvent) -> Any:
    return to_class(ResourcesAddedEvent, x)
