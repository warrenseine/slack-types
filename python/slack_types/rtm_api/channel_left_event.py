...
#
#     result = channel_left_event_from_dict(json.loads(json_string))
...
class ChannelLeftEvent:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ChannelLeftEvent':
        ...
        return ChannelLeftEvent(type, channel, actor_id, event_ts)
...
def channel_left_event_from_dict(s: Any) -> ChannelLeftEvent:
    return ChannelLeftEvent.from_dict(s)


def channel_left_event_to_dict(x: ChannelLeftEvent) -> Any:
    return to_class(ChannelLeftEvent, x)
