...
#
#     result = file_comment_edited_event_from_dict(json.loads(json_string))
...
class FileCommentEditedEvent:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'FileCommentEditedEvent':
        assert isinstance(obj, dict)
        ...
        return FileCommentEditedEvent(type, comment, file_id, file)
...
def file_comment_edited_event_from_dict(s: Any) -> FileCommentEditedEvent:
    return FileCommentEditedEvent.from_dict(s)


def file_comment_edited_event_to_dict(x: FileCommentEditedEvent) -> Any:
    return to_class(FileCommentEditedEvent, x)
