...
#
#     result = star_removed_event_from_dict(json.loads(json_string))
...
class ItemMessage:
    ...
    def from_dict(obj: Any) -> 'ItemMessage':
        ...
        permalink = from_union([from_str, from_none], obj.get("permalink"))
        edited = from_union([Edited.from_dict, from_none], obj.get("edited"))
        return ItemMessage(client_msg_id, type, app_id, team, user, bot_id, bot_profile, text, blocks, attachments, ts, pinned_to, permalink, edited)
...
class Item:
    ...
    def from_dict(obj: Any) -> 'Item':
        ...
        return Item(type, channel, created_by, date_create, message, file, comment)
...
def star_removed_event_from_dict(s: Any) -> StarRemovedEvent:
    return StarRemovedEvent.from_dict(s)


def star_removed_event_to_dict(x: StarRemovedEvent) -> Any:
    return to_class(StarRemovedEvent, x)
