...
#
#     result = chat_delete_response_from_dict(json.loads(json_string))
...
def chat_delete_response_from_dict(s: Any) -> ChatDeleteResponse:
    return ChatDeleteResponse.from_dict(s)


def chat_delete_response_to_dict(x: ChatDeleteResponse) -> Any:
    return to_class(ChatDeleteResponse, x)
