...
#
#     result = users_profile_set_response_from_dict(json.loads(json_string))
...
def users_profile_set_response_from_dict(s: Any) -> UsersProfileSetResponse:
    return UsersProfileSetResponse.from_dict(s)


def users_profile_set_response_to_dict(x: UsersProfileSetResponse) -> Any:
    return to_class(UsersProfileSetResponse, x)
