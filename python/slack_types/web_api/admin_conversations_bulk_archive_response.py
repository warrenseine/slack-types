...
#
#     result = admin_conversations_bulk_archive_response_from_dict(json.loads(json_string))
...
@dataclass
class AdminConversationsBulkArchiveResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'AdminConversationsBulkArchiveResponse':
        assert isinstance(obj, dict)
        ...
        return AdminConversationsBulkArchiveResponse(ok, error, needed, provided, bulk_action_id, not_added, response_metadata, warning)
...
def admin_conversations_bulk_archive_response_from_dict(s: Any) -> AdminConversationsBulkArchiveResponse:
    return AdminConversationsBulkArchiveResponse.from_dict(s)


def admin_conversations_bulk_archive_response_to_dict(x: AdminConversationsBulkArchiveResponse) -> Any:
    return to_class(AdminConversationsBulkArchiveResponse, x)
