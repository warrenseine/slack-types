...
#
#     result = search_all_response_from_dict(json.loads(json_string))
...
class DmMpdmUsersWithFileAccess:
    user_id: Optional[LastEditor] = None
    access: Optional[str] = None

    @staticmethod
    def from_dict(obj: Any) -> 'DmMpdmUsersWithFileAccess':
        assert isinstance(obj, dict)
        user_id = from_union([LastEditor, from_none], obj.get("user_id"))
        access = from_union([from_str, from_none], obj.get("access"))
        return DmMpdmUsersWithFileAccess(user_id, access)

    def to_dict(self) -> dict:
        result: dict = {}
        result["user_id"] = from_union([lambda x: to_enum(LastEditor, x), from_none], self.user_id)
...
class FileHeaders:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'FileHeaders':
        assert isinstance(obj, dict)
        ...
        return FileHeaders(date, in_reply_to, reply_to, message_id)
...
class Ts(Enum):
    EMPTY = ""
    THE_0000000000000000 = "0000000000.000000"


@dataclass
class Public:
    share_user_id: Optional[LastEditor] = None
    ...
    team_id: Optional[UserTeam] = None
    access: Optional[str] = None
    ...
    def from_dict(obj: Any) -> 'Public':
        assert isinstance(obj, dict)
        share_user_id = from_union([LastEditor, from_none], obj.get("share_user_id"))
        ...
        ts = from_union([Ts, from_none], obj.get("ts"))
        ...
        team_id = from_union([UserTeam, from_none], obj.get("team_id"))
        access = from_union([from_str, from_none], obj.get("access"))
        source = from_union([from_str, from_none], obj.get("source"))
        date_last_shared = from_union([from_int, from_none], obj.get("date_last_shared"))
        return Public(share_user_id, reply_users, reply_users_count, reply_count, ts, thread_ts, latest_reply, channel_name, team_id, access, source, date_last_shared)

    def to_dict(self) -> dict:
        result: dict = {}
        result["share_user_id"] = from_union([lambda x: to_enum(LastEditor, x), from_none], self.share_user_id)
        ...
        result["ts"] = from_union([lambda x: to_enum(Ts, x), from_none], self.ts)
        ...
        result["team_id"] = from_union([lambda x: to_enum(UserTeam, x), from_none], self.team_id)
        result["access"] = from_union([from_str, from_none], self.access)
...
class PurpleShares:
    ...
    private: Optional[Dict[str, List[Public]]] = None
    ...
    def from_dict(obj: Any) -> 'PurpleShares':
        ...
        private = from_union([lambda x: from_dict(lambda x: from_list(Public.from_dict, x), x), from_none], obj.get("private"))
    ...
    def to_dict(self) -> dict:
        ...
        result["private"] = from_union([lambda x: from_dict(lambda x: from_list(lambda x: to_class(Public, x), x), x), from_none], self.private)
        return result
...
class FileElement:
    ...
    headers: Optional[FileHeaders] = None
    ...
    def from_dict(obj: Any) -> 'FileElement':
        ...
        headers = from_union([FileHeaders.from_dict, from_none], obj.get("headers"))
    ...
    def to_dict(self) -> dict:
        ...
        result["headers"] = from_union([lambda x: to_class(FileHeaders, x), from_none], self.headers)
...
class MatchHeaders:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'MatchHeaders':
        assert isinstance(obj, dict)
        date = from_union([from_str, from_none], obj.get("date"))
        return MatchHeaders(date)
...
class MatchShares:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'MatchShares':
        assert isinstance(obj, dict)
        public = from_union([lambda x: from_dict(lambda x: from_list(Public.from_dict, x), x), from_none], obj.get("public"))
        return MatchShares(public)
...
class MatchTitleBlock:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'MatchTitleBlock':
        assert isinstance(obj, dict)
        type = from_union([BlockType, from_none], obj.get("type"))
        elements = from_union([lambda x: from_list(Accessory.from_dict, x), from_none], obj.get("elements"))
        block_id = from_union([from_str, from_none], obj.get("block_id"))
...
class FilesMatch:
    ...
    permalink: Optional[str] = None
    is_starred: Optional[bool] = None
    shares: Optional[MatchShares] = None
    channels: Optional[List[str]] = None
    groups: Optional[List[str]] = None
    ims: Optional[List[str]] = None
    external_id: Optional[str] = None
    ...
    file_access: Optional[str] = None
    user_team: Optional[UserTeam] = None
    has_more_shares: Optional[bool] = None
    subject: Optional[str] = None
    to: Optional[List[Cc]] = None
    match_from: Optional[List[Cc]] = None
    cc: Optional[List[Cc]] = None
    original_attachment_count: Optional[int] = None
    plain_text: Optional[str] = None
    preview_plain_text: Optional[str] = None
    headers: Optional[MatchHeaders] = None
    has_more: Optional[bool] = None
    sent_to_self: Optional[bool] = None
    bot_id: Optional[str] = None
    editors: Optional[List[str]] = None
    ...
    org_or_workspace_access: Optional[str] = None
    team_pref_version_history_enabled: Optional[bool] = None
    editors_count: Optional[int] = None
    is_channel_space: Optional[bool] = None
    linked_channel_id: Optional[str] = None
    thumb_360__gif: Optional[str] = None
    thumb_480__gif: Optional[str] = None
    ...
    title_blocks: Optional[List[MatchTitleBlock]] = None
    is_restricted_sharing_enabled: Optional[bool] = None
    canvas_printing_enabled: Optional[bool] = None

    @staticmethod
    def from_dict(obj: Any) -> 'FilesMatch':
        assert isinstance(obj, dict)
        id = from_union([from_str, from_none], obj.get("id"))
        created = from_union([from_int, from_none], obj.get("created"))
        timestamp = from_union([from_int, from_none], obj.get("timestamp"))
        ...
        filetype = from_union([from_str, from_none], obj.get("filetype"))
        pretty_type = from_union([from_str, from_none], obj.get("pretty_type"))
        user = from_union([LastEditor, from_none], obj.get("user"))
        editable = from_union([from_bool, from_none], obj.get("editable"))
        size = from_union([from_int, from_none], obj.get("size"))
        mode = from_union([from_str, from_none], obj.get("mode"))
        is_external = from_union([from_bool, from_none], obj.get("is_external"))
        ...
        permalink = from_union([from_str, from_none], obj.get("permalink"))
        is_starred = from_union([from_bool, from_none], obj.get("is_starred"))
        shares = from_union([MatchShares.from_dict, from_none], obj.get("shares"))
        channels = from_union([lambda x: from_list(from_str, x), from_none], obj.get("channels"))
        groups = from_union([lambda x: from_list(from_str, x), from_none], obj.get("groups"))
        ims = from_union([lambda x: from_list(from_str, x), from_none], obj.get("ims"))
        external_id = from_union([from_str, from_none], obj.get("external_id"))
        ...
        preview_is_truncated = from_union([from_bool, from_none], obj.get("preview_is_truncated"))
        image_exif_rotation = from_union([from_int, from_none], obj.get("image_exif_rotation"))
        last_editor = from_union([LastEditor, from_none], obj.get("last_editor"))
        non_owner_editable = from_union([from_bool, from_none], obj.get("non_owner_editable"))
        updated = from_union([from_int, from_none], obj.get("updated"))
        thumb_video = from_union([from_str, from_none], obj.get("thumb_video"))
        comments_count = from_union([from_int, from_none], obj.get("comments_count"))
        ...
        converted_pdf = from_union([from_str, from_none], obj.get("converted_pdf"))
        thumb_pdf = from_union([from_str, from_none], obj.get("thumb_pdf"))
        thumb_pdf_w = from_union([from_int, from_none], obj.get("thumb_pdf_w"))
        thumb_pdf_h = from_union([from_int, from_none], obj.get("thumb_pdf_h"))
        file_access = from_union([from_str, from_none], obj.get("file_access"))
        user_team = from_union([UserTeam, from_none], obj.get("user_team"))
        has_more_shares = from_union([from_bool, from_none], obj.get("has_more_shares"))
        subject = from_union([from_str, from_none], obj.get("subject"))
        to = from_union([lambda x: from_list(Cc.from_dict, x), from_none], obj.get("to"))
        match_from = from_union([lambda x: from_list(Cc.from_dict, x), from_none], obj.get("from"))
        cc = from_union([lambda x: from_list(Cc.from_dict, x), from_none], obj.get("cc"))
        original_attachment_count = from_union([from_int, from_none], obj.get("original_attachment_count"))
        plain_text = from_union([from_str, from_none], obj.get("plain_text"))
        preview_plain_text = from_union([from_str, from_none], obj.get("preview_plain_text"))
        headers = from_union([MatchHeaders.from_dict, from_none], obj.get("headers"))
        has_more = from_union([from_bool, from_none], obj.get("has_more"))
        sent_to_self = from_union([from_bool, from_none], obj.get("sent_to_self"))
        bot_id = from_union([from_str, from_none], obj.get("bot_id"))
        editors = from_union([lambda x: from_list(from_str, x), from_none], obj.get("editors"))
        ...
        org_or_workspace_access = from_union([from_str, from_none], obj.get("org_or_workspace_access"))
        team_pref_version_history_enabled = from_union([from_bool, from_none], obj.get("team_pref_version_history_enabled"))
        editors_count = from_union([from_int, from_none], obj.get("editors_count"))
        is_channel_space = from_union([from_bool, from_none], obj.get("is_channel_space"))
        linked_channel_id = from_union([from_str, from_none], obj.get("linked_channel_id"))
        thumb_360__gif = from_union([from_str, from_none], obj.get("thumb_360_gif"))
        thumb_480__gif = from_union([from_str, from_none], obj.get("thumb_480_gif"))
        ...
        title_blocks = from_union([lambda x: from_list(MatchTitleBlock.from_dict, x), from_none], obj.get("title_blocks"))
        is_restricted_sharing_enabled = from_union([from_bool, from_none], obj.get("is_restricted_sharing_enabled"))
        canvas_printing_enabled = from_union([from_bool, from_none], obj.get("canvas_printing_enabled"))
        return FilesMatch(id, created, timestamp, name, title, mimetype, filetype, pretty_type, user, editable, size, mode, is_external, external_type, is_public, public_url_shared, display_as_bot, username, url_private, thumb_64, thumb_80, thumb_360, thumb_360__w, thumb_360__h, thumb_480, thumb_480__w, thumb_480__h, thumb_160, thumb_720, thumb_720__w, thumb_720__h, thumb_800, thumb_800__w, thumb_800__h, thumb_960, thumb_960__w, thumb_960__h, thumb_1024, thumb_1024__w, thumb_1024__h, original_w, original_h, thumb_tiny, permalink, is_starred, shares, channels, groups, ims, external_id, external_url, has_rich_preview, url_private_download, permalink_public, edit_link, preview, preview_highlight, lines, lines_more, preview_is_truncated, image_exif_rotation, last_editor, non_owner_editable, updated, thumb_video, comments_count, media_display_type, converted_pdf, thumb_pdf, thumb_pdf_w, thumb_pdf_h, file_access, user_team, has_more_shares, subject, to, match_from, cc, original_attachment_count, plain_text, preview_plain_text, headers, has_more, sent_to_self, bot_id, editors, url_static_preview, quip_thread_id, update_notification, access, private_channels_with_file_access_count, dm_mpdm_users_with_file_access, teams_shared_with, org_or_workspace_access, team_pref_version_history_enabled, editors_count, is_channel_space, linked_channel_id, thumb_360__gif, thumb_480__gif, deanimate, deanimate_gif, private_file_with_access_count, attachments, title_blocks, is_restricted_sharing_enabled, canvas_printing_enabled)
    ...
    def to_dict(self) -> dict:
        ...
        result["filetype"] = from_union([from_str, from_none], self.filetype)
        result["pretty_type"] = from_union([from_str, from_none], self.pretty_type)
        result["user"] = from_union([lambda x: to_enum(LastEditor, x), from_none], self.user)
        result["editable"] = from_union([from_bool, from_none], self.editable)
        result["size"] = from_union([from_int, from_none], self.size)
        result["mode"] = from_union([from_str, from_none], self.mode)
        result["is_external"] = from_union([from_bool, from_none], self.is_external)
        ...
        result["permalink"] = from_union([from_str, from_none], self.permalink)
        result["is_starred"] = from_union([from_bool, from_none], self.is_starred)
        result["shares"] = from_union([lambda x: to_class(MatchShares, x), from_none], self.shares)
        result["channels"] = from_union([lambda x: from_list(from_str, x), from_none], self.channels)
        result["groups"] = from_union([lambda x: from_list(from_str, x), from_none], self.groups)
        result["ims"] = from_union([lambda x: from_list(from_str, x), from_none], self.ims)
        result["external_id"] = from_union([from_str, from_none], self.external_id)
        ...
        result["preview_is_truncated"] = from_union([from_bool, from_none], self.preview_is_truncated)
        result["image_exif_rotation"] = from_union([from_int, from_none], self.image_exif_rotation)
        result["last_editor"] = from_union([lambda x: to_enum(LastEditor, x), from_none], self.last_editor)
        result["non_owner_editable"] = from_union([from_bool, from_none], self.non_owner_editable)
        result["updated"] = from_union([from_int, from_none], self.updated)
        result["thumb_video"] = from_union([from_str, from_none], self.thumb_video)
        result["comments_count"] = from_union([from_int, from_none], self.comments_count)
        ...
        result["converted_pdf"] = from_union([from_str, from_none], self.converted_pdf)
        result["thumb_pdf"] = from_union([from_str, from_none], self.thumb_pdf)
        result["thumb_pdf_w"] = from_union([from_int, from_none], self.thumb_pdf_w)
        result["thumb_pdf_h"] = from_union([from_int, from_none], self.thumb_pdf_h)
        result["file_access"] = from_union([from_str, from_none], self.file_access)
        result["user_team"] = from_union([lambda x: to_enum(UserTeam, x), from_none], self.user_team)
        result["has_more_shares"] = from_union([from_bool, from_none], self.has_more_shares)
        result["subject"] = from_union([from_str, from_none], self.subject)
        result["to"] = from_union([lambda x: from_list(lambda x: to_class(Cc, x), x), from_none], self.to)
        result["from"] = from_union([lambda x: from_list(lambda x: to_class(Cc, x), x), from_none], self.match_from)
        result["cc"] = from_union([lambda x: from_list(lambda x: to_class(Cc, x), x), from_none], self.cc)
        result["original_attachment_count"] = from_union([from_int, from_none], self.original_attachment_count)
        result["plain_text"] = from_union([from_str, from_none], self.plain_text)
        result["preview_plain_text"] = from_union([from_str, from_none], self.preview_plain_text)
        result["headers"] = from_union([lambda x: to_class(MatchHeaders, x), from_none], self.headers)
        result["has_more"] = from_union([from_bool, from_none], self.has_more)
        result["sent_to_self"] = from_union([from_bool, from_none], self.sent_to_self)
        result["bot_id"] = from_union([from_str, from_none], self.bot_id)
        result["editors"] = from_union([lambda x: from_list(from_str, x), from_none], self.editors)
        ...
        result["org_or_workspace_access"] = from_union([from_str, from_none], self.org_or_workspace_access)
        result["team_pref_version_history_enabled"] = from_union([from_bool, from_none], self.team_pref_version_history_enabled)
        result["editors_count"] = from_union([from_int, from_none], self.editors_count)
        result["is_channel_space"] = from_union([from_bool, from_none], self.is_channel_space)
        result["linked_channel_id"] = from_union([from_str, from_none], self.linked_channel_id)
        result["thumb_360_gif"] = from_union([from_str, from_none], self.thumb_360__gif)
        result["thumb_480_gif"] = from_union([from_str, from_none], self.thumb_480__gif)
        ...
        result["title_blocks"] = from_union([lambda x: from_list(lambda x: to_class(MatchTitleBlock, x), x), from_none], self.title_blocks)
        result["is_restricted_sharing_enabled"] = from_union([from_bool, from_none], self.is_restricted_sharing_enabled)
        result["canvas_printing_enabled"] = from_union([from_bool, from_none], self.canvas_printing_enabled)
        return result
...
class Files:
    ...
    matches: Optional[List[FilesMatch]] = None
    ...
    def from_dict(obj: Any) -> 'Files':
        ...
        matches = from_union([lambda x: from_list(FilesMatch.from_dict, x), from_none], obj.get("matches"))
    ...
    def to_dict(self) -> dict:
        ...
        result["matches"] = from_union([lambda x: from_list(lambda x: to_class(FilesMatch, x), x), from_none], self.matches)
        return result
...
class Channel:
    ...
    def from_dict(obj: Any) -> 'Channel':
        ...
        is_file = from_union([from_bool, from_none], obj.get("is_file"))
        return Channel(id, is_channel, is_group, is_im, name, is_shared, is_org_shared, is_ext_shared, is_private, is_mpim, pending_shared, is_pending_ext_shared, user, name_normalized, is_file)
    ...
    def to_dict(self) -> dict:
        ...
        result["is_file"] = from_union([from_bool, from_none], self.is_file)
        return result
...
class Previous:
    ...
    permalink: Optional[str] = None
    attachments: Optional[List[Attachment]] = None
    blocks: Optional[List[MatchTitleBlock]] = None

    @staticmethod
    def from_dict(obj: Any) -> 'Previous':
        assert isinstance(obj, dict)
        type = from_union([from_str, from_none], obj.get("type"))
        user = from_union([LastEditor, from_none], obj.get("user"))
        username = from_union([from_str, from_none], obj.get("username"))
        ...
        permalink = from_union([from_str, from_none], obj.get("permalink"))
        attachments = from_union([lambda x: from_list(Attachment.from_dict, x), from_none], obj.get("attachments"))
        blocks = from_union([lambda x: from_list(MatchTitleBlock.from_dict, x), from_none], obj.get("blocks"))
        return Previous(type, user, username, ts, text, iid, permalink, attachments, blocks)
    ...
    def to_dict(self) -> dict:
        ...
        result["permalink"] = from_union([from_str, from_none], self.permalink)
        result["attachments"] = from_union([lambda x: from_list(lambda x: to_class(Attachment, x), x), from_none], self.attachments)
        result["blocks"] = from_union([lambda x: from_list(lambda x: to_class(MatchTitleBlock, x), x), from_none], self.blocks)
        return result
...
class MessagesMatch:
    ...
    text: Optional[str] = None
    permalink: Optional[str] = None
    no_reactions: Optional[bool] = None
    previous: Optional[Previous] = None
    previous_2: Optional[Previous] = None
    is_mpim: Optional[bool] = None
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'MessagesMatch':
        assert isinstance(obj, dict)
        iid = from_union([from_str, from_none], obj.get("iid"))
        team = from_union([UserTeam, from_none], obj.get("team"))
        ...
        text = from_union([from_str, from_none], obj.get("text"))
        permalink = from_union([from_str, from_none], obj.get("permalink"))
        no_reactions = from_union([from_bool, from_none], obj.get("no_reactions"))
        previous = from_union([Previous.from_dict, from_none], obj.get("previous"))
        previous_2 = from_union([Previous.from_dict, from_none], obj.get("previous_2"))
        is_mpim = from_union([from_bool, from_none], obj.get("is_mpim"))
        score = from_union([from_int, from_none], obj.get("score"))
        blocks = from_union([lambda x: from_list(MatchTitleBlock.from_dict, x), from_none], obj.get("blocks"))
        attachments = from_union([lambda x: from_list(Attachment.from_dict, x), from_none], obj.get("attachments"))
        files = from_union([lambda x: from_list(FileElement.from_dict, x), from_none], obj.get("files"))
        return MessagesMatch(iid, team, channel, type, user, username, ts, text, permalink, no_reactions, previous, previous_2, is_mpim, score, blocks, attachments, files)

    def to_dict(self) -> dict:
        result: dict = {}
        result["iid"] = from_union([from_str, from_none], self.iid)
        result["team"] = from_union([lambda x: to_enum(UserTeam, x), from_none], self.team)
        ...
        result["text"] = from_union([from_str, from_none], self.text)
        result["permalink"] = from_union([from_str, from_none], self.permalink)
        result["no_reactions"] = from_union([from_bool, from_none], self.no_reactions)
        result["previous"] = from_union([lambda x: to_class(Previous, x), from_none], self.previous)
        result["previous_2"] = from_union([lambda x: to_class(Previous, x), from_none], self.previous_2)
        result["is_mpim"] = from_union([from_bool, from_none], self.is_mpim)
...
class Messages:
    ...
    pagination: Optional[Pagination] = None
    paging: Optional[Paging] = None
    matches: Optional[List[MessagesMatch]] = None
    ...
    def from_dict(obj: Any) -> 'Messages':
        ...
        pagination = from_union([Pagination.from_dict, from_none], obj.get("pagination"))
        paging = from_union([Paging.from_dict, from_none], obj.get("paging"))
        matches = from_union([lambda x: from_list(MessagesMatch.from_dict, x), from_none], obj.get("matches"))
        return Messages(total, pagination, paging, matches)
    ...
    def to_dict(self) -> dict:
        ...
        result["pagination"] = from_union([lambda x: to_class(Pagination, x), from_none], self.pagination)
        result["paging"] = from_union([lambda x: to_class(Paging, x), from_none], self.paging)
        result["matches"] = from_union([lambda x: from_list(lambda x: to_class(MessagesMatch, x), x), from_none], self.matches)
        return result
...
class SearchAllResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'SearchAllResponse':
        assert isinstance(obj, dict)
        ok = from_union([from_bool, from_none], obj.get("ok"))
        error = from_union([from_str, from_none], obj.get("error"))
        query = from_union([from_str, from_none], obj.get("query"))
        messages = from_union([Messages.from_dict, from_none], obj.get("messages"))
        files = from_union([Files.from_dict, from_none], obj.get("files"))
        posts = from_union([Posts.from_dict, from_none], obj.get("posts"))
        needed = from_union([from_str, from_none], obj.get("needed"))
        provided = from_union([from_str, from_none], obj.get("provided"))
        return SearchAllResponse(ok, error, query, messages, files, posts, needed, provided)
    ...
    def to_dict(self) -> dict:
        ...
        result["messages"] = from_union([lambda x: to_class(Messages, x), from_none], self.messages)
        result["files"] = from_union([lambda x: to_class(Files, x), from_none], self.files)
        result["posts"] = from_union([lambda x: to_class(Posts, x), from_none], self.posts)
        result["needed"] = from_union([from_str, from_none], self.needed)
        result["provided"] = from_union([from_str, from_none], self.provided)
        return result


def search_all_response_from_dict(s: Any) -> SearchAllResponse:
    return SearchAllResponse.from_dict(s)


def search_all_response_to_dict(x: SearchAllResponse) -> Any:
    return to_class(SearchAllResponse, x)
