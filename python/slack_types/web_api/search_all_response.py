...
class Public:
    ...
    def from_dict(obj: Any) -> 'Public':
        ...
        team_id = from_union([Team, from_none], obj.get("team_id"))
        ...
        return Public(reply_users, reply_users_count, reply_count, ts, channel_name, team_id, share_user_id, thread_ts, latest_reply)
    ...
    def to_dict(self) -> dict:
        ...
        result["team_id"] = from_union([lambda x: to_enum(Team, x), from_none], self.team_id)
...
class File:
    ...
    groups: Optional[List[str]] = None
    ims: Optional[List[str]] = None
    shares: Optional[FileShares] = None
    ...
    def from_dict(obj: Any) -> 'File':
        ...
        groups = from_union([lambda x: from_list(from_str, x), from_none], obj.get("groups"))
        ims = from_union([lambda x: from_list(from_str, x), from_none], obj.get("ims"))
        shares = from_union([FileShares.from_dict, from_none], obj.get("shares"))
    ...
    def to_dict(self) -> dict:
        ...
        result["groups"] = from_union([lambda x: from_list(from_str, x), from_none], self.groups)
        result["ims"] = from_union([lambda x: from_list(from_str, x), from_none], self.ims)
        result["shares"] = from_union([lambda x: to_class(FileShares, x), from_none], self.shares)
...
class Channel:
    ...
    def from_dict(obj: Any) -> 'Channel':
        ...
        return Channel(id, is_channel, is_group, is_im, name, is_shared, is_org_shared, is_ext_shared, is_private, is_mpim, pending_shared, is_pending_ext_shared, user, name_normalized)
...
class MessagesMatch:
    ...
    def from_dict(obj: Any) -> 'MessagesMatch':
        assert isinstance(obj, dict)
        iid = from_union([from_str, from_none], obj.get("iid"))
        team = from_union([Team, from_none], obj.get("team"))
        ...
        files = from_union([lambda x: from_list(File.from_dict, x), from_none], obj.get("files"))
        return MessagesMatch(iid, team, channel, type, user, username, ts, text, permalink, no_reactions, previous, previous_2, blocks, attachments, is_mpim, score, files)

    def to_dict(self) -> dict:
        result: dict = {}
        result["iid"] = from_union([from_str, from_none], self.iid)
        result["team"] = from_union([lambda x: to_enum(Team, x), from_none], self.team)
