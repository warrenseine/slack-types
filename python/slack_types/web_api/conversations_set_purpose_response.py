...
#
#     result = conversations_set_purpose_response_from_dict(json.loads(json_string))
...
def conversations_set_purpose_response_from_dict(s: Any) -> ConversationsSetPurposeResponse:
    return ConversationsSetPurposeResponse.from_dict(s)


def conversations_set_purpose_response_to_dict(x: ConversationsSetPurposeResponse) -> Any:
    return to_class(ConversationsSetPurposeResponse, x)
