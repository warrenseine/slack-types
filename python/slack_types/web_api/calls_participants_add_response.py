...
#
#     result = calls_participants_add_response_from_dict(json.loads(json_string))
...
class CallsParticipantsAddResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'CallsParticipantsAddResponse':
        assert isinstance(obj, dict)
        ...
        return CallsParticipantsAddResponse(ok, call, error, needed, provided, warning)
...
def calls_participants_add_response_from_dict(s: Any) -> CallsParticipantsAddResponse:
    return CallsParticipantsAddResponse.from_dict(s)


def calls_participants_add_response_to_dict(x: CallsParticipantsAddResponse) -> Any:
    return to_class(CallsParticipantsAddResponse, x)
