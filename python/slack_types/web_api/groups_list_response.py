...
#
#     result = groups_list_response_from_dict(json.loads(json_string))
...
class Group:
    ...
    def from_dict(obj: Any) -> 'Group':
        ...
        return Group(id, name, is_group, created, creator, is_archived, name_normalized, is_mpim, members, topic, purpose, priority, is_open, last_read, parent_group)
...
class GroupsListResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'GroupsListResponse':
        assert isinstance(obj, dict)
        ...
        return GroupsListResponse(ok, groups, warning, response_metadata, error, needed, provided)
...
def groups_list_response_from_dict(s: Any) -> GroupsListResponse:
    return GroupsListResponse.from_dict(s)


def groups_list_response_to_dict(x: GroupsListResponse) -> Any:
    return to_class(GroupsListResponse, x)
