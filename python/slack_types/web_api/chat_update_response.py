...
class Metadata:
    ...
    def from_dict(obj: Any) -> 'Metadata':
        ...
        return Metadata(event_payload, event_type)
...
class Message:
    ...
    def from_dict(obj: Any) -> 'Message':
        ...
        return Message(bot_id, type, text, user, team, bot_profile, edited, upload, display_as_bot, x_files, app_id, metadata, room, files, blocks, assistant_app_thread)
