...
#
#     result = chat_update_response_from_dict(json.loads(json_string))
...
class Accessory:
    ...
    def from_dict(obj: Any) -> 'Accessory':
        ...
        return Accessory(type, image_url, alt_text, text, action_id, url, value, style, confirm, accessibility_label, options, initial_options, focus_on_load, initial_option, placeholder, initial_channel, response_url_enabled, initial_channels, max_selected_items, initial_conversation, default_to_current_conversation, filter, initial_conversations, initial_date, initial_time, min_query_length, fallback, image_width, image_height, image_bytes, option_groups, initial_user, initial_users)
...
class Block:
    ...
    def from_dict(obj: Any) -> 'Block':
        ...
        return Block(type, block_id, text, accessory, elements, call_id, api_decoration_available, call, external_id, source, fallback, image_url, image_width, image_height, image_bytes, alt_text, title, fields, label, element, dispatch_action, hint, optional)
...
class Message:
    ...
    def from_dict(obj: Any) -> 'Message':
        ...
        display_as_bot = from_union([from_bool, from_none], obj.get("display_as_bot"))
        return Message(bot_id, type, text, user, team, bot_profile, blocks, edited, files, upload, display_as_bot)
...
class ChatUpdateResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ChatUpdateResponse':
        assert isinstance(obj, dict)
        ...
        return ChatUpdateResponse(ok, channel, ts, text, message, error, needed, provided, response_metadata)
...
def chat_update_response_from_dict(s: Any) -> ChatUpdateResponse:
    return ChatUpdateResponse.from_dict(s)


def chat_update_response_to_dict(x: ChatUpdateResponse) -> Any:
    return to_class(ChatUpdateResponse, x)
