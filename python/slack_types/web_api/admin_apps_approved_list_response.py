...
#
#     result = admin_apps_approved_list_response_from_dict(json.loads(json_string))
...
class ApprovedApp:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ApprovedApp':
        assert isinstance(obj, dict)
        ...
        return ApprovedApp(app, scopes, date_updated, last_resolved_by)
...
class AdminAppsApprovedListResponse:
    ...
    approved_apps: Optional[List[ApprovedApp]] = None
    response_metadata: Optional[ResponseMetadata] = None

    @staticmethod
    def from_dict(obj: Any) -> 'AdminAppsApprovedListResponse':
        assert isinstance(obj, dict)
        ...
        approved_apps = from_union([lambda x: from_list(ApprovedApp.from_dict, x), from_none], obj.get("approved_apps"))
        response_metadata = from_union([ResponseMetadata.from_dict, from_none], obj.get("response_metadata"))
        return AdminAppsApprovedListResponse(ok, warning, error, needed, provided, approved_apps, response_metadata)
    ...
    def to_dict(self) -> dict:
        ...
        result["approved_apps"] = from_union([lambda x: from_list(lambda x: to_class(ApprovedApp, x), x), from_none], self.approved_apps)
        result["response_metadata"] = from_union([lambda x: to_class(ResponseMetadata, x), from_none], self.response_metadata)
        return result


def admin_apps_approved_list_response_from_dict(s: Any) -> AdminAppsApprovedListResponse:
    return AdminAppsApprovedListResponse.from_dict(s)


def admin_apps_approved_list_response_to_dict(x: AdminAppsApprovedListResponse) -> Any:
    return to_class(AdminAppsApprovedListResponse, x)
