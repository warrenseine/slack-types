...
#
#     result = files_revoke_public_url_response_from_dict(json.loads(json_string))
...
class FilesRevokePublicURLResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'FilesRevokePublicURLResponse':
        assert isinstance(obj, dict)
        ...
        return FilesRevokePublicURLResponse(ok, file, error, needed, provided)
...
def files_revoke_public_url_response_from_dict(s: Any) -> FilesRevokePublicURLResponse:
    return FilesRevokePublicURLResponse.from_dict(s)


def files_revoke_public_url_response_to_dict(x: FilesRevokePublicURLResponse) -> Any:
    return to_class(FilesRevokePublicURLResponse, x)
