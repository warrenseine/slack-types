...
#
#     result = files_remote_add_response_from_dict(json.loads(json_string))
...
class FilesRemoteAddResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'FilesRemoteAddResponse':
        assert isinstance(obj, dict)
        ...
        return FilesRemoteAddResponse(ok, file, error, needed, provided)
...
def files_remote_add_response_from_dict(s: Any) -> FilesRemoteAddResponse:
    return FilesRemoteAddResponse.from_dict(s)


def files_remote_add_response_to_dict(x: FilesRemoteAddResponse) -> Any:
    return to_class(FilesRemoteAddResponse, x)
