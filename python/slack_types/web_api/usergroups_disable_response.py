...
#
#     result = usergroups_disable_response_from_dict(json.loads(json_string))
...
def usergroups_disable_response_from_dict(s: Any) -> UsergroupsDisableResponse:
    return UsergroupsDisableResponse.from_dict(s)


def usergroups_disable_response_to_dict(x: UsergroupsDisableResponse) -> Any:
    return to_class(UsergroupsDisableResponse, x)
