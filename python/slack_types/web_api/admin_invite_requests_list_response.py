...
class AdminInviteRequestsListResponse:
    ...
    invite_requests: Optional[List[str]] = None
    ...
    def from_dict(obj: Any) -> 'AdminInviteRequestsListResponse':
        ...
        invite_requests = from_union([lambda x: from_list(from_str, x), from_none], obj.get("invite_requests"))
        error = from_union([from_str, from_none], obj.get("error"))
        needed = from_union([from_str, from_none], obj.get("needed"))
        provided = from_union([from_str, from_none], obj.get("provided"))
        return AdminInviteRequestsListResponse(ok, invite_requests, error, needed, provided)

    def to_dict(self) -> dict:
        result: dict = {}
        result["ok"] = from_union([from_bool, from_none], self.ok)
        result["invite_requests"] = from_union([lambda x: from_list(from_str, x), from_none], self.invite_requests)
