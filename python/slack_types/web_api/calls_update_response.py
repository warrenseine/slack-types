...
#
#     result = calls_update_response_from_dict(json.loads(json_string))
...
class CallsUpdateResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'CallsUpdateResponse':
        assert isinstance(obj, dict)
        ...
        return CallsUpdateResponse(ok, call, error, needed, provided, warning)
...
def calls_update_response_from_dict(s: Any) -> CallsUpdateResponse:
    return CallsUpdateResponse.from_dict(s)


def calls_update_response_to_dict(x: CallsUpdateResponse) -> Any:
    return to_class(CallsUpdateResponse, x)
