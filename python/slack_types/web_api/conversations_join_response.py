...
class ResponseMetadata:
    ...
    def from_dict(obj: Any) -> 'ResponseMetadata':
        ...
        return ResponseMetadata(warnings)
...
class ConversationsJoinResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ConversationsJoinResponse':
        assert isinstance(obj, dict)
        ...
        return ConversationsJoinResponse(ok, channel, warning, response_metadata, error, needed, provided)
...
def conversations_join_response_from_dict(s: Any) -> ConversationsJoinResponse:
    return ConversationsJoinResponse.from_dict(s)


def conversations_join_response_to_dict(x: ConversationsJoinResponse) -> Any:
    return to_class(ConversationsJoinResponse, x)
