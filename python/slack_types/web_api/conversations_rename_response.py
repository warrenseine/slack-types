...
#
#     result = conversations_rename_response_from_dict(json.loads(json_string))
...
class ConversationsRenameResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ConversationsRenameResponse':
        assert isinstance(obj, dict)
        ...
        return ConversationsRenameResponse(channel, ok, error, needed, provided)
...
def conversations_rename_response_from_dict(s: Any) -> ConversationsRenameResponse:
    return ConversationsRenameResponse.from_dict(s)


def conversations_rename_response_to_dict(x: ConversationsRenameResponse) -> Any:
    return to_class(ConversationsRenameResponse, x)
