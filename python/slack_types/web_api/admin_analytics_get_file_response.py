...
#
#     result = admin_analytics_get_file_response_from_dict(json.loads(json_string))
...
def admin_analytics_get_file_response_from_dict(s: Any) -> AdminAnalyticsGetFileResponse:
    return AdminAnalyticsGetFileResponse.from_dict(s)


def admin_analytics_get_file_response_to_dict(x: AdminAnalyticsGetFileResponse) -> Any:
    return to_class(AdminAnalyticsGetFileResponse, x)
