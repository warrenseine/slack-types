...
#
#     result = search_messages_response_from_dict(json.loads(json_string))
...
class MatchBlock:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'MatchBlock':
        assert isinstance(obj, dict)
        type = from_union([BlockType, from_none], obj.get("type"))
        elements = from_union([lambda x: from_list(Accessory.from_dict, x), from_none], obj.get("elements"))
        block_id = from_union([from_str, from_none], obj.get("block_id"))
...
class Previous:
    ...
    blocks: Optional[List[MatchBlock]] = None
    ...
    def from_dict(obj: Any) -> 'Previous':
        ...
        blocks = from_union([lambda x: from_list(MatchBlock.from_dict, x), from_none], obj.get("blocks"))
    ...
    def to_dict(self) -> dict:
        ...
        result["blocks"] = from_union([lambda x: from_list(lambda x: to_class(MatchBlock, x), x), from_none], self.blocks)
        return result
...
class Match:
    ...
    def from_dict(obj: Any) -> 'Match':
        ...
        attachments = from_union([lambda x: from_list(Attachment.from_dict, x), from_none], obj.get("attachments"))
        files = from_union([lambda x: from_list(FileElement.from_dict, x), from_none], obj.get("files"))
        return Match(iid, team, channel, type, user, username, ts, text, permalink, no_reactions, previous, previous_2, is_mpim, score, blocks, attachments, files)
...
class SearchMessagesResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'SearchMessagesResponse':
        assert isinstance(obj, dict)
        ...
        return SearchMessagesResponse(ok, query, messages, error, needed, provided)
...
def search_messages_response_from_dict(s: Any) -> SearchMessagesResponse:
    return SearchMessagesResponse.from_dict(s)


def search_messages_response_to_dict(x: SearchMessagesResponse) -> Any:
    return to_class(SearchMessagesResponse, x)
