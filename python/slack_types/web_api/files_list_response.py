...
#
#     result = files_list_response_from_dict(json.loads(json_string))
...
class File:
    ...
    def from_dict(obj: Any) -> 'File':
        ...
        return File(id, created, timestamp, name, title, mimetype, filetype, pretty_type, user, editable, size, mode, is_external, external_type, is_public, public_url_shared, display_as_bot, username, url_private, url_private_download, permalink, permalink_public, edit_link, preview, preview_highlight, lines, lines_more, preview_is_truncated, channels, groups, ims, comments_count, media_display_type, thumb_64, thumb_80, thumb_360, thumb_360__w, thumb_360__h, thumb_160, original_w, original_h, thumb_tiny, thumb_480, thumb_480__w, thumb_480__h, thumb_360__gif, thumb_480__gif, deanimate, deanimate_gif, thumb_720, thumb_720__w, thumb_720__h, thumb_800, thumb_800__w, thumb_800__h, thumb_960, thumb_960__w, thumb_960__h, thumb_1024, thumb_1024__w, thumb_1024__h, image_exif_rotation, subject, non_owner_editable, editor, last_editor, updated, original_attachment_count, external_id, external_url, app_id, app_name, thumb_64__gif, thumb_64__w, thumb_64__h, thumb_80__gif, thumb_80__w, thumb_80__h, thumb_160__gif, thumb_160__w, thumb_160__h, thumb_720__gif, thumb_800__gif, thumb_960__gif, thumb_1024__gif, thumb_video, thumb_gif, thumb_pdf, thumb_pdf_w, thumb_pdf_h, converted_pdf, pjpeg, has_rich_preview, plain_text, preview_plain_text, has_more, sent_to_self, shares, to, file_from, cc, channel_actions_ts, channel_actions_count, headers, simplified_html, bot_id, initial_comment, num_stars, is_starred, pinned_to, reactions, blocks)
...
class FilesListResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'FilesListResponse':
        assert isinstance(obj, dict)
        ...
        return FilesListResponse(ok, files, paging, error, needed, provided)
...
def files_list_response_from_dict(s: Any) -> FilesListResponse:
    return FilesListResponse.from_dict(s)


def files_list_response_to_dict(x: FilesListResponse) -> Any:
    return to_class(FilesListResponse, x)
