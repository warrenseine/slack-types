...
#
#     result = groups_set_topic_response_from_dict(json.loads(json_string))
...
class GroupsSetTopicResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'GroupsSetTopicResponse':
        assert isinstance(obj, dict)
        ...
        return GroupsSetTopicResponse(topic, ok, warning, response_metadata, error, needed, provided)
...
def groups_set_topic_response_from_dict(s: Any) -> GroupsSetTopicResponse:
    return GroupsSetTopicResponse.from_dict(s)


def groups_set_topic_response_to_dict(x: GroupsSetTopicResponse) -> Any:
    return to_class(GroupsSetTopicResponse, x)
