...
#
#     result = files_shared_public_url_response_from_dict(json.loads(json_string))
...
class FilesSharedPublicURLResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'FilesSharedPublicURLResponse':
        assert isinstance(obj, dict)
        ...
        return FilesSharedPublicURLResponse(ok, file, error, needed, provided)
...
def files_shared_public_url_response_from_dict(s: Any) -> FilesSharedPublicURLResponse:
    return FilesSharedPublicURLResponse.from_dict(s)


def files_shared_public_url_response_to_dict(x: FilesSharedPublicURLResponse) -> Any:
    return to_class(FilesSharedPublicURLResponse, x)
