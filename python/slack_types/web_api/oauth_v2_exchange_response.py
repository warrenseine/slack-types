...
#
#     result = oauth_v2_exchange_response_from_dict(json.loads(json_string))
...
class OauthV2ExchangeResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'OauthV2ExchangeResponse':
        assert isinstance(obj, dict)
        ...
        return OauthV2ExchangeResponse(ok, warning, error, needed, provided, app_id, authed_user, scope, token_type, access_token, refresh_token, expires_in, bot_user_id, team, enterprise, is_enterprise_install, incoming_webhook, response_metadata)
...
def oauth_v2_exchange_response_from_dict(s: Any) -> OauthV2ExchangeResponse:
    return OauthV2ExchangeResponse.from_dict(s)


def oauth_v2_exchange_response_to_dict(x: OauthV2ExchangeResponse) -> Any:
    return to_class(OauthV2ExchangeResponse, x)
