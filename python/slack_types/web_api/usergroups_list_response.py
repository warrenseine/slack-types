...
class Usergroup:
    ...
    def from_dict(obj: Any) -> 'Usergroup':
        ...
        return Usergroup(id, team_id, is_usergroup, is_subteam, name, description, handle, is_external, date_create, date_update, date_delete, auto_provision, enterprise_subteam_id, created_by, updated_by, prefs, channel_count)
...
class UsergroupsListResponse:
    ...
    def from_dict(obj: Any) -> 'UsergroupsListResponse':
        ...
        return UsergroupsListResponse(ok, usergroups, error, needed, provided)
