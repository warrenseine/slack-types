...
#
#     result = usergroups_list_response_from_dict(json.loads(json_string))
...
class Usergroup:
    ...
    def from_dict(obj: Any) -> 'Usergroup':
        ...
        return Usergroup(id, team_id, is_usergroup, is_subteam, name, description, handle, is_external, date_create, date_update, date_delete, auto_provision, enterprise_subteam_id, created_by, updated_by, prefs, channel_count, users, user_count, is_section, is_idp_group, is_visible, is_editing_restricted, is_membership_locked, is_org_level, deleted_by)
...
class UsergroupsListResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'UsergroupsListResponse':
        assert isinstance(obj, dict)
        ok = from_union([from_bool, from_none], obj.get("ok"))
        usergroups = from_union([lambda x: from_list(Usergroup.from_dict, x), from_none], obj.get("usergroups"))
        error = from_union([from_str, from_none], obj.get("error"))
        needed = from_union([from_str, from_none], obj.get("needed"))
        provided = from_union([from_str, from_none], obj.get("provided"))
        warning = from_union([from_str, from_none], obj.get("warning"))
        return UsergroupsListResponse(ok, usergroups, error, needed, provided, warning)

    def to_dict(self) -> dict:
        result: dict = {}
        result["ok"] = from_union([from_bool, from_none], self.ok)
        result["usergroups"] = from_union([lambda x: from_list(lambda x: to_class(Usergroup, x), x), from_none], self.usergroups)
...
def usergroups_list_response_from_dict(s: Any) -> UsergroupsListResponse:
    return UsergroupsListResponse.from_dict(s)


def usergroups_list_response_to_dict(x: UsergroupsListResponse) -> Any:
    return to_class(UsergroupsListResponse, x)
