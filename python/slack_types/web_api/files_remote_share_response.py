...
#
#     result = files_remote_share_response_from_dict(json.loads(json_string))
...
class FilesRemoteShareResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'FilesRemoteShareResponse':
        assert isinstance(obj, dict)
        ...
        return FilesRemoteShareResponse(ok, file, error, needed, provided)
...
def files_remote_share_response_from_dict(s: Any) -> FilesRemoteShareResponse:
    return FilesRemoteShareResponse.from_dict(s)


def files_remote_share_response_to_dict(x: FilesRemoteShareResponse) -> Any:
    return to_class(FilesRemoteShareResponse, x)
