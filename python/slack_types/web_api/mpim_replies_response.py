...
#
#     result = mpim_replies_response_from_dict(json.loads(json_string))
...
class MpimRepliesResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'MpimRepliesResponse':
        assert isinstance(obj, dict)
        ...
        return MpimRepliesResponse(messages, has_more, ok, warning, response_metadata, error, needed, provided)
...
def mpim_replies_response_from_dict(s: Any) -> MpimRepliesResponse:
    return MpimRepliesResponse.from_dict(s)


def mpim_replies_response_to_dict(x: MpimRepliesResponse) -> Any:
    return to_class(MpimRepliesResponse, x)
