...
class Message:
    ...
    def from_dict(obj: Any) -> 'Message':
        ...
        return Message(bot_id, type, text, user, ts, team, bot_profile, thread_ts, parent_user_id, subtype, username, icons, root, blocks, attachments)
