...
#
#     result = apps_manifest_validate_response_from_dict(json.loads(json_string))
...
@dataclass
class AppsManifestValidateResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'AppsManifestValidateResponse':
        assert isinstance(obj, dict)
        ...
        return AppsManifestValidateResponse(ok, error, response_metadata, needed, provided, errors, warning)
...
def apps_manifest_validate_response_from_dict(s: Any) -> AppsManifestValidateResponse:
    return AppsManifestValidateResponse.from_dict(s)


def apps_manifest_validate_response_to_dict(x: AppsManifestValidateResponse) -> Any:
    return to_class(AppsManifestValidateResponse, x)
