...
#
#     result = admin_conversations_bulk_delete_response_from_dict(json.loads(json_string))
...
@dataclass
class AdminConversationsBulkDeleteResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'AdminConversationsBulkDeleteResponse':
        assert isinstance(obj, dict)
        ...
        return AdminConversationsBulkDeleteResponse(ok, error, needed, provided, bulk_action_id, not_added, response_metadata, warning)
...
def admin_conversations_bulk_delete_response_from_dict(s: Any) -> AdminConversationsBulkDeleteResponse:
    return AdminConversationsBulkDeleteResponse.from_dict(s)


def admin_conversations_bulk_delete_response_to_dict(x: AdminConversationsBulkDeleteResponse) -> Any:
    return to_class(AdminConversationsBulkDeleteResponse, x)
