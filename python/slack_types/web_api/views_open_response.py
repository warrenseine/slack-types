...
#
#     result = views_open_response_from_dict(json.loads(json_string))
...
class ViewsOpenResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ViewsOpenResponse':
        assert isinstance(obj, dict)
        ...
        return ViewsOpenResponse(ok, warning, error, needed, provided, view, response_metadata)
...
def views_open_response_from_dict(s: Any) -> ViewsOpenResponse:
    return ViewsOpenResponse.from_dict(s)


def views_open_response_to_dict(x: ViewsOpenResponse) -> Any:
    return to_class(ViewsOpenResponse, x)
