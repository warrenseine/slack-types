...
#
#     result = channels_create_response_from_dict(json.loads(json_string))
...
class Channel:
    ...
    def from_dict(obj: Any) -> 'Channel':
        ...
        return Channel(id, name, is_channel, created, is_archived, is_general, unlinked, creator, name_normalized, is_shared, is_org_shared, is_member, is_private, is_mpim, last_read, unread_count, unread_count_display, members, topic, purpose, previous_names, priority)
...
class ChannelsCreateResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ChannelsCreateResponse':
        assert isinstance(obj, dict)
        ...
        return ChannelsCreateResponse(ok, channel, error, needed, provided)
...
def channels_create_response_from_dict(s: Any) -> ChannelsCreateResponse:
    return ChannelsCreateResponse.from_dict(s)


def channels_create_response_to_dict(x: ChannelsCreateResponse) -> Any:
    return to_class(ChannelsCreateResponse, x)
