...
#
#     result = files_remote_update_response_from_dict(json.loads(json_string))
...
class FilesRemoteUpdateResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'FilesRemoteUpdateResponse':
        assert isinstance(obj, dict)
        ...
        return FilesRemoteUpdateResponse(ok, file, error, needed, provided)
...
def files_remote_update_response_from_dict(s: Any) -> FilesRemoteUpdateResponse:
    return FilesRemoteUpdateResponse.from_dict(s)


def files_remote_update_response_to_dict(x: FilesRemoteUpdateResponse) -> Any:
    return to_class(FilesRemoteUpdateResponse, x)
