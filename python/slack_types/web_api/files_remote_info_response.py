...
#
#     result = files_remote_info_response_from_dict(json.loads(json_string))
...
class FilesRemoteInfoResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'FilesRemoteInfoResponse':
        assert isinstance(obj, dict)
        ...
        return FilesRemoteInfoResponse(ok, file, error, needed, provided)
...
def files_remote_info_response_from_dict(s: Any) -> FilesRemoteInfoResponse:
    return FilesRemoteInfoResponse.from_dict(s)


def files_remote_info_response_to_dict(x: FilesRemoteInfoResponse) -> Any:
    return to_class(FilesRemoteInfoResponse, x)
