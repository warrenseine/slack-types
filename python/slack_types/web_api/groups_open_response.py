...
#
#     result = groups_open_response_from_dict(json.loads(json_string))
...
class GroupsOpenResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'GroupsOpenResponse':
        assert isinstance(obj, dict)
        ...
        return GroupsOpenResponse(ok, no_op, already_open, warning, response_metadata, error, needed, provided)
...
def groups_open_response_from_dict(s: Any) -> GroupsOpenResponse:
    return GroupsOpenResponse.from_dict(s)


def groups_open_response_to_dict(x: GroupsOpenResponse) -> Any:
    return to_class(GroupsOpenResponse, x)
