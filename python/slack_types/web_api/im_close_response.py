...
#
#     result = im_close_response_from_dict(json.loads(json_string))
...
class IMCloseResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'IMCloseResponse':
        assert isinstance(obj, dict)
        ...
        return IMCloseResponse(ok, warning, response_metadata, error, needed, provided)
...
def im_close_response_from_dict(s: Any) -> IMCloseResponse:
    return IMCloseResponse.from_dict(s)


def im_close_response_to_dict(x: IMCloseResponse) -> Any:
    return to_class(IMCloseResponse, x)
