...
class AdminInviteRequestsDeniedListResponse:
    ...
    denied_requests: Optional[List[str]] = None
    ...
    def from_dict(obj: Any) -> 'AdminInviteRequestsDeniedListResponse':
        ...
        denied_requests = from_union([lambda x: from_list(from_str, x), from_none], obj.get("denied_requests"))
        error = from_union([from_str, from_none], obj.get("error"))
        needed = from_union([from_str, from_none], obj.get("needed"))
        provided = from_union([from_str, from_none], obj.get("provided"))
        return AdminInviteRequestsDeniedListResponse(ok, denied_requests, error, needed, provided)

    def to_dict(self) -> dict:
        result: dict = {}
        result["ok"] = from_union([from_bool, from_none], self.ok)
        result["denied_requests"] = from_union([lambda x: from_list(from_str, x), from_none], self.denied_requests)
