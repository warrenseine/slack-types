...
#
#     result = admin_barriers_update_response_from_dict(json.loads(json_string))
...
@dataclass
class AdminBarriersUpdateResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'AdminBarriersUpdateResponse':
        assert isinstance(obj, dict)
        ...
        return AdminBarriersUpdateResponse(ok, error, barrier, needed, provided)
...
def admin_barriers_update_response_from_dict(s: Any) -> AdminBarriersUpdateResponse:
    return AdminBarriersUpdateResponse.from_dict(s)


def admin_barriers_update_response_to_dict(x: AdminBarriersUpdateResponse) -> Any:
    return to_class(AdminBarriersUpdateResponse, x)
