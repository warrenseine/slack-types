...
#
#     result = usergroups_users_update_response_from_dict(json.loads(json_string))
...
def usergroups_users_update_response_from_dict(s: Any) -> UsergroupsUsersUpdateResponse:
    return UsergroupsUsersUpdateResponse.from_dict(s)


def usergroups_users_update_response_to_dict(x: UsergroupsUsersUpdateResponse) -> Any:
    return to_class(UsergroupsUsersUpdateResponse, x)
