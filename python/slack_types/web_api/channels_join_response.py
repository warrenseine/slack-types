...
#
#     result = channels_join_response_from_dict(json.loads(json_string))
...
class ChannelsJoinResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ChannelsJoinResponse':
        assert isinstance(obj, dict)
        ...
        return ChannelsJoinResponse(ok, channel, error, needed, provided)
...
def channels_join_response_from_dict(s: Any) -> ChannelsJoinResponse:
    return ChannelsJoinResponse.from_dict(s)


def channels_join_response_to_dict(x: ChannelsJoinResponse) -> Any:
    return to_class(ChannelsJoinResponse, x)
