...
#
#     result = calls_participants_remove_response_from_dict(json.loads(json_string))
...
class CallsParticipantsRemoveResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'CallsParticipantsRemoveResponse':
        assert isinstance(obj, dict)
        ...
        return CallsParticipantsRemoveResponse(ok, call, error, needed, provided, warning)
...
def calls_participants_remove_response_from_dict(s: Any) -> CallsParticipantsRemoveResponse:
    return CallsParticipantsRemoveResponse.from_dict(s)


def calls_participants_remove_response_to_dict(x: CallsParticipantsRemoveResponse) -> Any:
    return to_class(CallsParticipantsRemoveResponse, x)
