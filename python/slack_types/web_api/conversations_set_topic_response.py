...
#
#     result = conversations_set_topic_response_from_dict(json.loads(json_string))
...
class ConversationsSetTopicResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ConversationsSetTopicResponse':
        assert isinstance(obj, dict)
        ...
        return ConversationsSetTopicResponse(ok, channel, error, needed, provided, warning)
...
def conversations_set_topic_response_from_dict(s: Any) -> ConversationsSetTopicResponse:
    return ConversationsSetTopicResponse.from_dict(s)


def conversations_set_topic_response_to_dict(x: ConversationsSetTopicResponse) -> Any:
    return to_class(ConversationsSetTopicResponse, x)
