...
#
#     result = calls_end_response_from_dict(json.loads(json_string))
...
class Call:
    ...
    def from_dict(obj: Any) -> 'Call':
        ...
        return Call(id, date_start, external_unique_id, join_url, date_end, channels, external_display_id, title, desktop_app_join_url, users)
...
class CallsEndResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'CallsEndResponse':
        assert isinstance(obj, dict)
        ...
        return CallsEndResponse(ok, call, error, needed, provided, warning)
...
def calls_end_response_from_dict(s: Any) -> CallsEndResponse:
    return CallsEndResponse.from_dict(s)


def calls_end_response_to_dict(x: CallsEndResponse) -> Any:
    return to_class(CallsEndResponse, x)
