...
class AdminInviteRequestsApprovedListResponse:
    ...
    approved_requests: Optional[List[str]] = None
    ...
    def from_dict(obj: Any) -> 'AdminInviteRequestsApprovedListResponse':
        ...
        approved_requests = from_union([lambda x: from_list(from_str, x), from_none], obj.get("approved_requests"))
        error = from_union([from_str, from_none], obj.get("error"))
        needed = from_union([from_str, from_none], obj.get("needed"))
        provided = from_union([from_str, from_none], obj.get("provided"))
        return AdminInviteRequestsApprovedListResponse(ok, approved_requests, error, needed, provided)

    def to_dict(self) -> dict:
        result: dict = {}
        result["ok"] = from_union([from_bool, from_none], self.ok)
        result["approved_requests"] = from_union([lambda x: from_list(from_str, x), from_none], self.approved_requests)
