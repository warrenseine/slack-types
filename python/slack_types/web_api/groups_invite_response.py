...
#
#     result = groups_invite_response_from_dict(json.loads(json_string))
...
class Latest:
    ...
    def from_dict(obj: Any) -> 'Latest':
        ...
        return Latest(type, subtype, ts, user, text, topic)
...
class Group:
    ...
    def from_dict(obj: Any) -> 'Group':
        ...
        return Group(id, name, is_group, created, creator, is_archived, name_normalized, is_mpim, is_open, last_read, latest, unread_count, unread_count_display, topic, purpose, priority)
...
class GroupsInviteResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'GroupsInviteResponse':
        assert isinstance(obj, dict)
        ...
        return GroupsInviteResponse(ok, group, warning, response_metadata, error, needed, provided)
...
def groups_invite_response_from_dict(s: Any) -> GroupsInviteResponse:
    return GroupsInviteResponse.from_dict(s)


def groups_invite_response_to_dict(x: GroupsInviteResponse) -> Any:
    return to_class(GroupsInviteResponse, x)
