...
#
#     result = groups_info_response_from_dict(json.loads(json_string))
...
class Group:
    ...
    def from_dict(obj: Any) -> 'Group':
        ...
        return Group(id, name, is_group, created, creator, is_archived, name_normalized, is_mpim, is_open, last_read, latest, unread_count, unread_count_display, members, topic, purpose)
...
class GroupsInfoResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'GroupsInfoResponse':
        assert isinstance(obj, dict)
        ...
        return GroupsInfoResponse(ok, group, warning, response_metadata, error, needed, provided)
...
def groups_info_response_from_dict(s: Any) -> GroupsInfoResponse:
    return GroupsInfoResponse.from_dict(s)


def groups_info_response_to_dict(x: GroupsInfoResponse) -> Any:
    return to_class(GroupsInfoResponse, x)
