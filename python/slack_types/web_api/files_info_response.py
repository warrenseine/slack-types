...
#   filename:  tmpnq4ezjw_.schema.json
...
class FilesInfoResponse(BaseModel):
    ...
    content_highlight_html: str | None = None
    content_highlight_css: str | None = None
    comments: List[Comment] | None = None
    paging: Paging | None = None
    error: str | None = None
    needed: str | None = None
    provided: str | None = None
    content_highlight_html_truncated: bool | None = None
