...
#
#     result = files_info_response_from_dict(json.loads(json_string))
...
class FilesInfoResponse:
    ...
    content_highlight_html: Optional[str] = None
    content_highlight_css: Optional[str] = None
    comments: Optional[List[Comment]] = None
    paging: Optional[Paging] = None
    error: Optional[str] = None
    needed: Optional[str] = None
    provided: Optional[str] = None
    content_highlight_html_truncated: Optional[bool] = None

    @staticmethod
    def from_dict(obj: Any) -> 'FilesInfoResponse':
        assert isinstance(obj, dict)
        ok = from_union([from_bool, from_none], obj.get("ok"))
        file = from_union([File.from_dict, from_none], obj.get("file"))
        content = from_union([from_str, from_none], obj.get("content"))
        is_truncated = from_union([from_bool, from_none], obj.get("is_truncated"))
        content_highlight_html = from_union([from_str, from_none], obj.get("content_highlight_html"))
        content_highlight_css = from_union([from_str, from_none], obj.get("content_highlight_css"))
        ...
        content_highlight_html_truncated = from_union([from_bool, from_none], obj.get("content_highlight_html_truncated"))
        return FilesInfoResponse(ok, file, content, is_truncated, content_highlight_html, content_highlight_css, comments, paging, error, needed, provided, content_highlight_html_truncated)
    ...
    def to_dict(self) -> dict:
        ...
        result["content"] = from_union([from_str, from_none], self.content)
        result["is_truncated"] = from_union([from_bool, from_none], self.is_truncated)
        result["content_highlight_html"] = from_union([from_str, from_none], self.content_highlight_html)
        result["content_highlight_css"] = from_union([from_str, from_none], self.content_highlight_css)
        ...
        result["content_highlight_html_truncated"] = from_union([from_bool, from_none], self.content_highlight_html_truncated)
        return result


def files_info_response_from_dict(s: Any) -> FilesInfoResponse:
    return FilesInfoResponse.from_dict(s)


def files_info_response_to_dict(x: FilesInfoResponse) -> Any:
    return to_class(FilesInfoResponse, x)
