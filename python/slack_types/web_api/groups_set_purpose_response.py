...
#
#     result = groups_set_purpose_response_from_dict(json.loads(json_string))
...
@dataclass
class GroupsSetPurposeResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'GroupsSetPurposeResponse':
        assert isinstance(obj, dict)
        ...
        return GroupsSetPurposeResponse(ok, purpose, warning, response_metadata, error, needed, provided)
...
def groups_set_purpose_response_from_dict(s: Any) -> GroupsSetPurposeResponse:
    return GroupsSetPurposeResponse.from_dict(s)


def groups_set_purpose_response_to_dict(x: GroupsSetPurposeResponse) -> Any:
    return to_class(GroupsSetPurposeResponse, x)
