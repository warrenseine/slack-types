...
#
#     result = usergroups_update_response_from_dict(json.loads(json_string))
...
class Usergroup:
    ...
    def from_dict(obj: Any) -> 'Usergroup':
        ...
        return Usergroup(id, team_id, is_usergroup, is_subteam, name, description, handle, is_external, date_create, date_update, date_delete, auto_provision, enterprise_subteam_id, created_by, updated_by, prefs, channel_count, users, is_section, is_idp_group, is_visible, is_editing_restricted, is_membership_locked, is_org_level)
...
class UsergroupsUpdateResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'UsergroupsUpdateResponse':
        assert isinstance(obj, dict)
        ...
        return UsergroupsUpdateResponse(ok, usergroup, error, needed, provided, warning)
...
def usergroups_update_response_from_dict(s: Any) -> UsergroupsUpdateResponse:
    return UsergroupsUpdateResponse.from_dict(s)


def usergroups_update_response_to_dict(x: UsergroupsUpdateResponse) -> Any:
    return to_class(UsergroupsUpdateResponse, x)
