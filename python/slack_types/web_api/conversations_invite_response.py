...
#
#     result = conversations_invite_response_from_dict(json.loads(json_string))
...
class ConversationsInviteResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ConversationsInviteResponse':
        assert isinstance(obj, dict)
        ok = from_union([from_bool, from_none], obj.get("ok"))
        ...
        return ConversationsInviteResponse(ok, channel, error, needed, provided, errors, warning)
...
def conversations_invite_response_from_dict(s: Any) -> ConversationsInviteResponse:
    return ConversationsInviteResponse.from_dict(s)


def conversations_invite_response_to_dict(x: ConversationsInviteResponse) -> Any:
    return to_class(ConversationsInviteResponse, x)
