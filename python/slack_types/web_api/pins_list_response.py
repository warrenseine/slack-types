...
#
#     result = pins_list_response_from_dict(json.loads(json_string))
...
class Item:
    ...
    def from_dict(obj: Any) -> 'Item':
        ...
        comment = from_union([from_str, from_none], obj.get("comment"))
        return Item(type, created, created_by, file, comment)
...
class PinsListResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'PinsListResponse':
        assert isinstance(obj, dict)
        ...
        return PinsListResponse(ok, items, error, needed, provided)
...
def pins_list_response_from_dict(s: Any) -> PinsListResponse:
    return PinsListResponse.from_dict(s)


def pins_list_response_to_dict(x: PinsListResponse) -> Any:
    return to_class(PinsListResponse, x)
