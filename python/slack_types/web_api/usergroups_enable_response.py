...
#
#     result = usergroups_enable_response_from_dict(json.loads(json_string))
...
class UsergroupsEnableResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'UsergroupsEnableResponse':
        assert isinstance(obj, dict)
        ...
        return UsergroupsEnableResponse(ok, usergroup, error, needed, provided, warning)
...
def usergroups_enable_response_from_dict(s: Any) -> UsergroupsEnableResponse:
    return UsergroupsEnableResponse.from_dict(s)


def usergroups_enable_response_to_dict(x: UsergroupsEnableResponse) -> Any:
    return to_class(UsergroupsEnableResponse, x)
