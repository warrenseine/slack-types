...
#
#     result = files_upload_response_from_dict(json.loads(json_string))
...
class FilesUploadResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'FilesUploadResponse':
        assert isinstance(obj, dict)
        ...
        return FilesUploadResponse(ok, file, error, needed, provided)
...
def files_upload_response_from_dict(s: Any) -> FilesUploadResponse:
    return FilesUploadResponse.from_dict(s)


def files_upload_response_to_dict(x: FilesUploadResponse) -> Any:
    return to_class(FilesUploadResponse, x)
