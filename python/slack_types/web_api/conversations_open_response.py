...
class Latest:
    ...
    def from_dict(obj: Any) -> 'Latest':
        ...
        return Latest(type, subtype, text, ts, bot_id, client_msg_id, user, team, bot_profile, app_id, blocks, assistant_app_thread)
...
class Channel:
    ...
    def from_dict(obj: Any) -> 'Channel':
        ...
        updated = from_union([from_int, from_none], obj.get("updated"))
        return Channel(id, created, is_archived, is_im, is_org_shared, user, last_read, latest, unread_count, unread_count_display, is_open, priority, context_team_id, updated)
