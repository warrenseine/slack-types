...
#
#     result = mpim_history_response_from_dict(json.loads(json_string))
...
class Message:
    ...
    def from_dict(obj: Any) -> 'Message':
        ...
        return Message(bot_id, type, text, user, ts, team, bot_profile, thread_ts, parent_user_id, reply_count, reply_users_count, latest_reply, reply_users, subscribed, last_read, is_starred)
...
class MpimHistoryResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'MpimHistoryResponse':
        assert isinstance(obj, dict)
        ...
        return MpimHistoryResponse(ok, messages, has_more, channel_actions_count, warning, response_metadata, error, needed, provided)
...
def mpim_history_response_from_dict(s: Any) -> MpimHistoryResponse:
    return MpimHistoryResponse.from_dict(s)


def mpim_history_response_to_dict(x: MpimHistoryResponse) -> Any:
    return to_class(MpimHistoryResponse, x)
