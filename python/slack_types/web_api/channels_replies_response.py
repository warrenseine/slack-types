...
#
#     result = channels_replies_response_from_dict(json.loads(json_string))
...
class Message:
    ...
    def from_dict(obj: Any) -> 'Message':
        ...
        return Message(bot_id, type, text, user, ts, team, bot_profile, thread_ts, reply_count, reply_users_count, latest_reply, reply_users, subscribed, parent_user_id)
...
class ChannelsRepliesResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ChannelsRepliesResponse':
        assert isinstance(obj, dict)
        ...
        return ChannelsRepliesResponse(messages, has_more, ok, warning, response_metadata, error, needed, provided)
...
def channels_replies_response_from_dict(s: Any) -> ChannelsRepliesResponse:
    return ChannelsRepliesResponse.from_dict(s)


def channels_replies_response_to_dict(x: ChannelsRepliesResponse) -> Any:
    return to_class(ChannelsRepliesResponse, x)
