...
#
#     result = im_mark_response_from_dict(json.loads(json_string))
...
class IMMarkResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'IMMarkResponse':
        assert isinstance(obj, dict)
        ...
        return IMMarkResponse(ok, warning, response_metadata, error, needed, provided)
...
def im_mark_response_from_dict(s: Any) -> IMMarkResponse:
    return IMMarkResponse.from_dict(s)


def im_mark_response_to_dict(x: IMMarkResponse) -> Any:
    return to_class(IMMarkResponse, x)
