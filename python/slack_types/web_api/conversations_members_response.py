...
#
#     result = conversations_members_response_from_dict(json.loads(json_string))
...
def conversations_members_response_from_dict(s: Any) -> ConversationsMembersResponse:
    return ConversationsMembersResponse.from_dict(s)


def conversations_members_response_to_dict(x: ConversationsMembersResponse) -> Any:
    return to_class(ConversationsMembersResponse, x)
