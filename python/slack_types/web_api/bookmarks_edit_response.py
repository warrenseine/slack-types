...
#
#     result = bookmarks_edit_response_from_dict(json.loads(json_string))
...
def bookmarks_edit_response_from_dict(s: Any) -> BookmarksEditResponse:
    return BookmarksEditResponse.from_dict(s)


def bookmarks_edit_response_to_dict(x: BookmarksEditResponse) -> Any:
    return to_class(BookmarksEditResponse, x)
