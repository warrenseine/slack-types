...
class Message:
    ...
    def from_dict(obj: Any) -> 'Message':
        ...
        display_as_bot = from_union([from_bool, from_none], obj.get("display_as_bot"))
        return Message(bot_id, type, text, user, ts, team, bot_profile, thread_ts, reply_count, reply_users_count, latest_reply, reply_users, subscribed, parent_user_id, is_locked, blocks, attachments, last_read, files, upload, display_as_bot)
