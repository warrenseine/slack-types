...
class PurpleIcons:
    ...
    def from_dict(obj: Any) -> 'PurpleIcons':
        ...
        emoji = from_union([from_str, from_none], obj.get("emoji"))
        image_64 = from_union([from_str, from_none], obj.get("image_64"))
        return PurpleIcons(emoji, image_64)
...
class MessageElement:
    ...
    def from_dict(obj: Any) -> 'MessageElement':
        ...
        assistant_app_thread = from_union([AssistantAppThread.from_dict, from_none], obj.get("assistant_app_thread"))
        return MessageElement(type, subtype, text, bot_id, ts, thread_ts, root, username, icons, parent_user_id, reply_count, reply_users_count, latest_reply, reply_users, subscribed, user, team, bot_profile, upload, display_as_bot, x_files, edited, topic, purpose, client_msg_id, reactions, app_id, metadata, inviter, is_locked, files, blocks, attachments, assistant_app_thread)
...
class ConversationsHistoryResponse:
    ...
    def from_dict(obj: Any) -> 'ConversationsHistoryResponse':
        ...
        oldest = from_union([from_str, from_none], obj.get("oldest"))
        latest = from_union([from_str, from_none], obj.get("latest"))
        return ConversationsHistoryResponse(ok, messages, has_more, pin_count, channel_actions_ts, channel_actions_count, response_metadata, error, needed, provided, oldest, latest)
    ...
    def to_dict(self) -> dict:
        ...
        result["oldest"] = from_union([from_str, from_none], self.oldest)
