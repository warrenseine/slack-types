...
#
#     result = slack_lists_items_create_response_from_dict(json.loads(json_string))
...
class Field:
    ...
    def from_dict(obj: Any) -> 'Field':
        ...
        return Field(key, column_id, value, rich_text, checkbox)
...
@dataclass
class SlackListsItemsCreateResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'SlackListsItemsCreateResponse':
        assert isinstance(obj, dict)
        ...
        return SlackListsItemsCreateResponse(ok, item, response_metadata, error, needed, provided, warning)
...
def slack_lists_items_create_response_from_dict(s: Any) -> SlackListsItemsCreateResponse:
    return SlackListsItemsCreateResponse.from_dict(s)


def slack_lists_items_create_response_to_dict(x: SlackListsItemsCreateResponse) -> Any:
    return to_class(SlackListsItemsCreateResponse, x)
