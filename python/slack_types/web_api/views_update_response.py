...
class ViewsUpdateResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'ViewsUpdateResponse':
        assert isinstance(obj, dict)
        ...
        return ViewsUpdateResponse(ok, warning, error, needed, provided, view, response_metadata)
...
def views_update_response_from_dict(s: Any) -> ViewsUpdateResponse:
    return ViewsUpdateResponse.from_dict(s)


def views_update_response_to_dict(x: ViewsUpdateResponse) -> Any:
    return to_class(ViewsUpdateResponse, x)
