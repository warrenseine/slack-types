...
#
#     result = groups_create_response_from_dict(json.loads(json_string))
...
class Group:
    ...
    def from_dict(obj: Any) -> 'Group':
        ...
        return Group(id, name, is_group, created, creator, is_archived, name_normalized, is_mpim, is_open, last_read, unread_count, unread_count_display, topic, purpose, priority, members)
...
class GroupsCreateResponse:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'GroupsCreateResponse':
        assert isinstance(obj, dict)
        ...
        return GroupsCreateResponse(ok, group, warning, response_metadata, error, needed, provided)
...
def groups_create_response_from_dict(s: Any) -> GroupsCreateResponse:
    return GroupsCreateResponse.from_dict(s)


def groups_create_response_to_dict(x: GroupsCreateResponse) -> Any:
    return to_class(GroupsCreateResponse, x)
