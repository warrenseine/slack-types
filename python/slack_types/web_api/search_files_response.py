...
class ListMetadata:
    ...
    description_blocks: Optional[List[Block]] = None
    ...
    def from_dict(obj: Any) -> 'ListMetadata':
        ...
        description_blocks = from_union([lambda x: from_list(Block.from_dict, x), from_none], obj.get("description_blocks"))
    ...
    def to_dict(self) -> dict:
        ...
        result["description_blocks"] = from_union([lambda x: from_list(lambda x: to_class(Block, x), x), from_none], self.description_blocks)
        return result
...
class TitleBlock:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'TitleBlock':
        assert isinstance(obj, dict)
        type = from_union([BlockType, from_none], obj.get("type"))
        elements = from_union([lambda x: from_list(Accessory.from_dict, x), from_none], obj.get("elements"))
        block_id = from_union([from_str, from_none], obj.get("block_id"))
...
class Match:
    ...
    title_blocks: Optional[List[TitleBlock]] = None
    is_restricted_sharing_enabled: Optional[bool] = None
    canvas_printing_enabled: Optional[bool] = None
    ...
    def to_dict(self) -> dict:
        ...
        result["title_blocks"] = from_union([lambda x: from_list(lambda x: to_class(TitleBlock, x), x), from_none], self.title_blocks)
        result["is_restricted_sharing_enabled"] = from_union([from_bool, from_none], self.is_restricted_sharing_enabled)
        result["canvas_printing_enabled"] = from_union([from_bool, from_none], self.canvas_printing_enabled)
        return result
